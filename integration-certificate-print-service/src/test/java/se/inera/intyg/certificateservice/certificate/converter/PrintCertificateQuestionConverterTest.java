...
class PrintCertificateQuestionConverterTest {
  ...
  private static final ElementSpecification ELEMENT_SPECIFICATION =
      ElementSpecification.builder()
          .id(new ElementId("1"))
          .configuration(ElementConfigurationDate.builder().name("Beräknat födelsedatum").build())
          .children(
              List.of(
                  ElementSpecification.builder()
                      .id(new ElementId("2"))
                      .configuration(
                          ElementConfigurationTextArea.builder().name(DESCRIPTION).build())
                      .build()))
          .build();

  private static final ElementSpecification ELEMENT_SPECIFICATION_MULTIPLE_DATES =
      ElementSpecification.builder()
          .id(new ElementId("2"))
          .configuration(
      ...
      MedicalCertificate.builder()
          .elementData(
              List.of(
                  ...
                  ElementData.builder()
                      .id(new ElementId("2"))
                      .value(ElementValueText.builder().text(TEXT).build())
                      .build()))
          .build();
  ...
  private static final Certificate CERTIFICATE_EMPTY =
      MedicalCertificate.builder()
          .elementData(
              List.of(
                  ElementData.builder()
                      .id(new ElementId("1"))
                      .value(ElementValueDate.builder().dateId(new FieldId("1.1")).build())
                      .build()))
          .build();

  private static final ElementSpecification ELEMENT_SPECIFICATION_HIDDEN_VALUES =
      ElementSpecification.builder()
          .id(new ElementId("1"))
          .configuration(ElementConfigurationTextArea.builder().name(DESCRIPTION).build())
          .pdfConfiguration(
              CitizenPdfConfiguration.builder()
                  .hiddenBy(new ElementId("1"))
                  .replacementValue(
                      ElementSimplifiedValueText.builder().text("Dold information").build())
                  .build())
          .build();
  ...
  private static final PdfGeneratorOptions OPTIONS =
      PdfGeneratorOptions.builder()
          ...
          .build();
  private static final PdfGeneratorOptions OPTIONS_CITIZEN =
      PdfGeneratorOptions.builder()
          .additionalInfoText(TEXT)
          .citizenFormat(true)
          .hiddenElements(HIDDEN_ELEMENTS)
  ...
  void shouldSetName() {
    final var response =
        printCertificateQuestionConverter.convert(ELEMENT_SPECIFICATION, CERTIFICATE, OPTIONS);
    ...
    final var expected =
        Optional.of(
            PrintCertificateQuestionDTO.builder()
                ...
                .value(ElementSimplifiedValueTextDTO.builder().text("Ej angivet").build())
                .subquestions(
                    List.of(
                        PrintCertificateQuestionDTO.builder()
                            .id("2")
                            .name("Beskrivning")
                            .value(
                                ElementSimplifiedValueTextDTO.builder().text("Ej angivet").build())
  ...
  void shouldConvertChildren() {
    final var expected =
        PrintCertificateQuestionDTO.builder()
            .name(DESCRIPTION)
            .id("2")
            .value(ElementSimplifiedValueTextDTO.builder().text(TEXT).build())
            .subquestions(Collections.emptyList())
            .build();
  ...
  void shouldSetValueMultipleDates() {
    final var expected =
        ElementSimplifiedValueLabeledListDTO.builder()
            .list(
                List.of(
  ...
  void shouldReplaceSimplifiedValue() {
    final var expected = ElementSimplifiedValueTextDTO.builder().text("Dold information").build();
