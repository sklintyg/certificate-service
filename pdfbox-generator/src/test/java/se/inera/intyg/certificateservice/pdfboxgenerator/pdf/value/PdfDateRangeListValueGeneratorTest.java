...
class PdfDateRangeListValueGeneratorTest {
  ...
  private static final DateRange DATE_RANGE_2 =
      DateRange.builder()
  ...
  private static final DateRange DATE_RANGE_3 =
      DateRange.builder()
  ...
  private static final DateRange DATE_RANGE_ONLY_FROM =
      DateRange.builder()
          .dateRangeId(new FieldId(CodeSystemKvFkmu0008.EN_ATTONDEL.code()))
          .from(LocalDate.now().minusDays(1))
          .build();

  private static final DateRange DATE_RANGE_ONLY_TO =
      DateRange.builder()
          .dateRangeId(new FieldId(CodeSystemKvFkmu0008.TRE_FJARDEDELAR.code()))
          .to(LocalDate.now().plusDays(10))
          .build();

  private static final PdfDateRangeListValueGenerator pdfDateRangeListValueGenerator =
      new PdfDateRangeListValueGenerator();
  ...
  void shouldSetValueIfElementDataWithDateRangeList() {
    ...
    final var elementValue =
        ElementValueDateRangeList.builder().dateRangeList(List.of(DATE_RANGE)).build();
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder().id(FIELD_PREFIX + ".ksr_Hela[0]").value("1").build())),
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder()
  ...
  void shouldSetValueIfElementDataWithDateRangeListIncludingSeveralDateRanges() {
    ...
    final var elementValue =
        ElementValueDateRangeList.builder()
            .dateRangeList(List.of(DATE_RANGE, DATE_RANGE_2))
            .build();
  ...
  void shouldSetValueIfElementDataWithDateRangeListIncludingSeveralDateRangesAndSomeNotWhole() {
    ...
    final var elementValue =
        ElementValueDateRangeList.builder()
            .dateRangeList(List.of(DATE_RANGE_ONLY_FROM, DATE_RANGE_3, DATE_RANGE_ONLY_TO))
            .build();
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder().id(FIELD_PREFIX + ".ksr_Halva[0]").value("1").build())),
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder()
        ...
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder().id(FIELD_PREFIX + ".ksr_EnAttondel[0]").value("1").build())),
        () ->
            assertTrue(
                result.contains(
                    PdfField.builder()
