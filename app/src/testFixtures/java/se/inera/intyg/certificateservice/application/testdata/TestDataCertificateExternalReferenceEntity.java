...
public class TestDataCertificateExternalReferenceEntity {
  ...
  public static final ExternalReferenceEntity EXTERNAL_REFERENCE =
      externalReferenceBuilder().build();

  public static ExternalReferenceEntity.ExternalReferenceEntityBuilder externalReferenceBuilder() {
    return ExternalReferenceEntity.builder().reference(EXTERNAL_REF);
  }
}
