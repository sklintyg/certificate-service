...
class PatientInternalControllerTest {
  ...
  @Mock private GetSickLeaveCertificatesInternalService getSickLeaveCertificatesInternalService;
  @InjectMocks private PatientInternalController patientInternalController;
  ...
  void shallReturnGetSickLeaveCertificatesInternalResponse() {
    ...
    final var expectedResult =
        GetSickLeaveCertificatesInternalResponse.builder().certificates(certificates).build();
