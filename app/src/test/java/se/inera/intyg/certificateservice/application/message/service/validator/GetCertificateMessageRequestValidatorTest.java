...
class GetCertificateMessageRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private GetCertificateMessageRequestValidator requestValidator;
  private GetCertificateMessageRequest.GetCertificateMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new GetCertificateMessageRequestValidator();
    requestBuilder =
