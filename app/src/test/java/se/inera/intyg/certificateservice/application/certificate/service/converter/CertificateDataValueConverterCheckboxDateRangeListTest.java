...
class CertificateDataValueConverterCheckboxDateRangeListTest {
  ...
  private final CertificateDataValueConverterCheckboxDateRangeList converter =
      new CertificateDataValueConverterCheckboxDateRangeList();
  private ElementConfigurationCheckboxDateRangeListBuilder elementConfigurationBuilder;

  @BeforeEach
  void setUp() {
    elementConfigurationBuilder = ElementConfigurationCheckboxDateRangeList.builder().id(FIELD_ID);
  }
  ...
  void shouldThrowExceptionIfWrongClassOfValue() {
    final var configuration =
        ElementSpecification.builder()
            ...
            .configuration(ElementConfigurationCheckboxDateRangeList.builder().id(FIELD_ID).build())
            .build();
  ...
  void shallCreateCertificateDataValue() {
    final var configuration =
        ElementSpecification.builder()
            .id(new ElementId(ELEMENT_ID))
            .configuration(elementConfigurationBuilder.build())
            .build();
  ...
  void shallSetCorrectIdForDateRangeValue() {
    ...
    assertEquals(
        elementValue.dateRangeList().get(0).dateRangeId().value(),
  ...
  void shallSetCorrectToDateForDateRangeValue() {
    ...
    assertEquals(
        elementValue.dateRangeList().get(0).to(),
  ...
  void shallSetCorrectFromDateForDateRangeValue() {
    ...
    assertEquals(
        elementValue.dateRangeList().get(0).from(),
  ...
  void shallSetValueToNull() {
    ...
    assertTrue(
        ((CertificateDataValueDateRangeList) result).getList().isEmpty(),
