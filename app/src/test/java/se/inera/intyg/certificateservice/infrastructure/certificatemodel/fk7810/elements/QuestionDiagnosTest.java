            ...
            .diagnoses(
                Map.of(
                    ...
                    PdfConfigurationDiagnosis.builder()
                        .pdfNameFieldId(new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos[0]"))
                        .pdfCodeFieldIds(
                            List.of(
                    ...
                    new FieldId("diagnos2"),
                    PdfConfigurationDiagnosis.builder()
                        .pdfNameFieldId(new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos2[0]"))
                        .pdfCodeFieldIds(
                            List.of(
                    ...
                    new FieldId("diagnos3"),
                    PdfConfigurationDiagnosis.builder()
                        .pdfNameFieldId(new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos3[0]"))
                        .pdfCodeFieldIds(
                            List.of(
                    ...
                    new FieldId("diagnos4"),
                    PdfConfigurationDiagnosis.builder()
                        .pdfNameFieldId(new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos4[0]"))
                        .pdfCodeFieldIds(
                            List.of(
                    ...
                    new FieldId("diagnos5"),
                    PdfConfigurationDiagnosis.builder()
                        .pdfNameFieldId(new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos5[0]"))
                        .pdfCodeFieldIds(
                            List.of(
