...
class AnswerComplementServiceTest {
  ...
  @Mock private AnswerComplementRequestValidator answerComplementRequestValidator;
  @Mock private AnswerComplementDomainService answerComplementDomainService;
  @Mock private CertificateConverter certificateConverter;
  @Mock private ResourceLinkConverter resourceLinkConverter;
  @InjectMocks private AnswerComplementService answerComplementService;

  @Test
  void shallThrowIfRequestIsInvalid() {
    final var request = AnswerComplementRequest.builder().build();
    doThrow(IllegalArgumentException.class)
        .when(answerComplementRequestValidator)
  ...
  void shallReturnAnswerComplementResponse() {
    ...
    final var expectedResponse =
        AnswerComplementResponse.builder().certificate(certificateDTO).build();
    ...
    doReturn(certificate)
        .when(answerComplementDomainService)
        .answer(new CertificateId(CERTIFICATE_ID), actionEvaluation, new Content(MESSAGE));
    ...
    final var actualResult =
        answerComplementService.answer(
