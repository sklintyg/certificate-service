...
class GetCertificateCandidateRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private GetCertificateCandidateRequestValidator validator;
  private GetCertificateCandidateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new GetCertificateCandidateRequestValidator();
    requestBuilder =
