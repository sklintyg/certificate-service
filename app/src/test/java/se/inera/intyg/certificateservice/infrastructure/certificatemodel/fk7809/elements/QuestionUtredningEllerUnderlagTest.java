  ...
  void shallIncludePdfConfiguration() {
    final var expectedOptions =
        Map.ofEntries(
            ...
            entry(AUDIONOM.code(), "Underlag från audionom"),
            entry(DIETIST.code(), "Underlag från dietist"),
            entry(ORTOPTIST.code(), "Underlag från ortopist"),
            entry(ORTOPEDTEKNIKER.code(), "Underlag från ortopedtekniker eller ortopedingenjör"),
