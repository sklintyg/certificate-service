...
class ForwardCertificateRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private ForwardCertificateRequestValidator forwardCertificateRequestValidator;
  private ForwardCertificateRequest.ForwardCertificateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    forwardCertificateRequestValidator = new ForwardCertificateRequestValidator();
    requestBuilder =
  ...
  @Test
  void validRequest() {
    forwardCertificateRequestValidator.validate(requestBuilder.build(), CERTIFICATE_ID);
  }
    ...
    void shallThrowIfUserIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              ...
              () -> forwardCertificateRequestValidator.validate(request, CERTIFICATE_ID));
  ...
  class CertificateIdValidation {
    ...
    void shallThrowIfCertificateIdIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> forwardCertificateRequestValidator.validate(request, null));
    ...
    void shallThrowIfCertificateIdIsEmpty() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> forwardCertificateRequestValidator.validate(request, ""));
