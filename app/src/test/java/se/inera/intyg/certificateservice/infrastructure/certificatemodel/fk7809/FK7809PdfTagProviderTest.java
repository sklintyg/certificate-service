...
class FK7809PdfTagProviderTest {

  private static final PdfTagIndex EXPECTED_TAG_INDEX = new PdfTagIndex(10);

  @Mock private Certificate certificate;

  private final FK7809PdfTagProvider provider = new FK7809PdfTagProvider();
