...
class MessageRelationRepositoryTest {
  ...
  @Mock MessageRelation messageRelationOne;
  @Mock MessageRelation messageRelationTwo;
  MessageRelationRepository messageRelationRepository;

  @BeforeEach
  void setUp() {
    messageRelationRepository =
        new MessageRelationRepository(List.of(messageRelationOne, messageRelationTwo));
  }
