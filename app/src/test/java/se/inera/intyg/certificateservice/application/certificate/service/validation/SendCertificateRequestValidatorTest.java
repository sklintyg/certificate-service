...
class SendCertificateRequestValidatorTest {
  ...
  private SendCertificateRequestValidator validator;
  private SendCertificateRequest.SendCertificateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new SendCertificateRequestValidator();
    requestBuilder =
