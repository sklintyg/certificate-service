...
class GetCertificateFromMessageRequestValidatorTest {

  private static final String MESSAGE_ID = "messageId";
  private GetCertificateFromMessageRequestValidator requestValidator;
  private GetCertificateFromMessageRequest.GetCertificateFromMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new GetCertificateFromMessageRequestValidator();
    requestBuilder =
