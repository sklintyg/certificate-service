...
class CreateMessageRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private CreateMessageRequestValidator requestValidator;
  private CreateMessageRequest.CreateMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new CreateMessageRequestValidator();
    requestBuilder =
  ...
  @Test
  void validRequest() {
    requestValidator.validate(requestBuilder.build(), CERTIFICATE_ID);
  }
    ...
    void shallThrowIfUserIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              ...
              () -> requestValidator.validate(request, CERTIFICATE_ID));
  ...
  void shallThrowIfQuestionTypeIsNull() {
    final var request = requestBuilder.questionType(null).build();
    ...
    assertEquals("Required parameter missing: questionType", illegalArgumentException.getMessage());
  }
}
