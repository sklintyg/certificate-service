...
class FK7427PdfTagProviderTest {

  private static final PdfTagIndex TAG_INDEX = new PdfTagIndex(28);

  @Mock private Certificate certificate;

  private final FK7427PdfTagProvider provider = new FK7427PdfTagProvider();
