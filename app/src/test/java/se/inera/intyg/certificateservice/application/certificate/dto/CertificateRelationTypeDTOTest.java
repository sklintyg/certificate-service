...
class CertificateRelationTypeDTOTest {
  ...
  void shallConvertReplace() {
    assertEquals(
        CertificateRelationTypeDTO.REPLACED,
  ...
  void shallConvertRenew() {
    assertEquals(
        CertificateRelationTypeDTO.EXTENDED, CertificateRelationTypeDTO.toType(RelationType.RENEW));
  }

  @Test
  void shallConvertComplement() {
    assertEquals(
        CertificateRelationTypeDTO.COMPLEMENTED,
