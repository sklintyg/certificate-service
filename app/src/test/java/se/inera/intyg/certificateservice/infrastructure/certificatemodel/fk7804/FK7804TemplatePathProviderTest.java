...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk7804.FK7804TemplatePathProvider.PDF_FK_7804_PDF;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk7804.FK7804TemplatePathProvider.PDF_NO_ADDRESS_FK_7804_PDF;
...
class FK7804TemplatePathProviderTest {
  ...
  void shallReturnWithAddressTemplateWhenNotCitizenAndNotSent() {
    ...
    assertEquals(PDF_FK_7804_PDF, path);
  }
  ...
  void shallReturnNoAddressTemplateWhenCitizenFormat() {
    ...
    assertEquals(PDF_NO_ADDRESS_FK_7804_PDF, path);
  }
