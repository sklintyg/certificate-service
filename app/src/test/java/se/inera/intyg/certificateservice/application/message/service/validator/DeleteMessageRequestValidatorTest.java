...
class DeleteMessageRequestValidatorTest {

  private static final String MESSAGE_ID = "messageId";
  private DeleteMessageRequestValidator requestValidator;
  private DeleteMessageRequest.DeleteMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new DeleteMessageRequestValidator();
    requestBuilder =
