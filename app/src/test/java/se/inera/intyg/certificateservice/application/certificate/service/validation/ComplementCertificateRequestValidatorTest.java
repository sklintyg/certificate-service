...
class ComplementCertificateRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private ComplementCertificateRequestValidator validator;
  private ComplementCertificateRequest.ComplementCertificateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new ComplementCertificateRequestValidator();
    requestBuilder =
