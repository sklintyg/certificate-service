...
class SendMessageRequestValidatorTest {
  ...
  private SendMessageRequestValidator requestValidator;
  private SendMessageRequest.SendMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new SendMessageRequestValidator();
    requestBuilder =
