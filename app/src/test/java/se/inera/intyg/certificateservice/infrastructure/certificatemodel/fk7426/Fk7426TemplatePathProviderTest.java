...
class FK7426TemplatePathProviderTest {
  ...
  private final FK7426TemplatePathProvider provider = new FK7426TemplatePathProvider();

  @Test
  void shallReturnNoAddressTemplatePath() {
    assertEquals(PDF_NO_ADDRESS_FK_7426_PDF, provider.pathWithoutAddress());
  }

  @Test
  void shallReturnPdfTemplatePathWithAddress() {
    assertEquals(PDF_FK_7426_PDF, provider.pathWithAddress());
  }
}
