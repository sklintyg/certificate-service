...
class GetCertificateXmlRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private GetCertificateXmlRequestValidator validator;
  private GetCertificateXmlRequest.GetCertificateXmlRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new GetCertificateXmlRequestValidator();
    requestBuilder =
