...
class RenewCertificateRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private RenewCertificateRequestValidator validator;
  private RenewCertificateRequest.RenewCertificateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new RenewCertificateRequestValidator();
    requestBuilder =
