...
class DeleteAnswerRequestValidatorTest {

  private static final String MESSAGE_ID = "messageId";
  private DeleteAnswerRequestValidator requestValidator;
  private DeleteAnswerRequest.DeleteAnswerRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new DeleteAnswerRequestValidator();
    requestBuilder =
