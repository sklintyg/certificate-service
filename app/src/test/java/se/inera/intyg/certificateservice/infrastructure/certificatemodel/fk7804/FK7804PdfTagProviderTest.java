...
class FK7804PdfTagProviderTest {

  private static final PdfTagIndex TAG_INDEX = new PdfTagIndex(10);

  @Mock private Certificate certificate;

  private final FK7804PdfTagProvider provider = new FK7804PdfTagProvider();
