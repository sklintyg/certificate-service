...
class FK7472PdfTagProviderTest {

  private static final PdfTagIndex TAG_WITH_ADDRESS = new PdfTagIndex(50);
  private static final PdfTagIndex TAG_WITHOUT_ADDRESS = new PdfTagIndex(47);

  @Mock private Certificate certificate;

  private final FK7472PdfTagProvider provider = new FK7472PdfTagProvider();
  ...
  void shallReturnWithAddressTagWhenNotCitizenAndNotSent() {
    ...
    assertEquals(TAG_WITH_ADDRESS, tag);
  }

  @Test
  void shallReturnWithoutAddressTagWhenCitizenFormat() {
    final var tag = provider.of(certificate, options(true));

    assertEquals(TAG_WITHOUT_ADDRESS, tag);
  }

  @Test
  void shallReturnWithoutAddressTagWhenSent() {
