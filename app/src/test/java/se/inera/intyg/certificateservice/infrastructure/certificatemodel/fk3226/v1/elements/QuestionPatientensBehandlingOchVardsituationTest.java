...
class QuestionPatientensBehandlingOchVardsituationTest {
  ...
  @Test
  void shallIncludeId() {
    final var element = questionPatientBehandlingOchVardsituation(new FK3226V1TextProvider());
              ...
              .list(
                  List.of(
                      new ElementConfigurationCode(
                          ...
                          CodeSystemKvFkmu0009.ENDAST_PALLIATIV_V1),
                      new ElementConfigurationCode(
                          new FieldId("AKUT_LIVSHOTANDE"),
  ...
  class V1_1 {
    ...
    void shallIncludeConfiguration() {
      ...
      final var element = questionPatientBehandlingOchVardsituation(new FK3226V1_1TextProvider());
