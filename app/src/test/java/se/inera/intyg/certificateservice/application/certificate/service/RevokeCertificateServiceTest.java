...
class RevokeCertificateServiceTest {
  ...
  @Mock private RevokeCertificateRequestValidator revokeCertificateRequestValidator;
  @Mock private RevokeCertificateDomainService revokeCertificateDomainService;
  @Mock private CertificateConverter certificateConverter;
  @Mock private ResourceLinkConverter resourceLinkConverter;
  @InjectMocks private RevokeCertificateService revokeCertificateService;

  @Test
  void shallThrowIfRequestIsInvalid() {
    final var request = RevokeCertificateRequest.builder().build();
    doThrow(IllegalArgumentException.class)
        .when(revokeCertificateRequestValidator)
  ...
  void shallReturnResponseWithCertificate() {
    ...
    final var expectedResponse =
        RevokeCertificateResponse.builder().certificate(certificateDTO).build();
    ...
    doReturn(certificate)
        .when(revokeCertificateDomainService)
        .revoke(
            new CertificateId(CERTIFICATE_ID),
            actionEvaluation,
            new RevokedInformation(
                REVOKE_INFORMATION_DTO.getReason(), REVOKE_INFORMATION_DTO.getMessage()));
    ...
    final var actualResult =
        revokeCertificateService.revoke(
