...
class GetCertificatePdfRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private static final String ADDITIONAL_INFO_TEXT = "ADDITIONAL_INFO_TEXT";
  private GetCertificatePdfRequestValidator validator;
  private GetCertificatePdfRequest.GetCertificatePdfRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new GetCertificatePdfRequestValidator();
    requestBuilder =
        GetCertificatePdfRequest.builder()
  ...
  @Nested
  class AdditonalInfoTextValidation {

    @Test
    void shallThrowIfAdditonalInfoTextIsNull() {
      final var request = requestBuilder.additionalInfoText(null).build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> validator.validate(request, CERTIFICATE_ID));

      assertEquals(
          "Required parameter missing: additionalInfoText", illegalArgumentException.getMessage());
    }

    @Test
    void shallThrowIfAdditonalInfoTextIsEmpty() {
      final var request = requestBuilder.additionalInfoText("").build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> validator.validate(request, CERTIFICATE_ID));
