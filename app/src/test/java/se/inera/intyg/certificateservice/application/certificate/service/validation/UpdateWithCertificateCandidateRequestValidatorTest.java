...
class UpdateWithCertificateCandidateRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private static final String CANDIDATE_CERTIFICATE_ID = "candidateCertificateId";
  private UpdateWithCertificateCandidateRequestValidator validator;
  private UpdateWithCertificateCandidateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new UpdateWithCertificateCandidateRequestValidator();
    requestBuilder =
  ...
  @Test
  void validRequest() {
    validator.validate(requestBuilder.build(), CERTIFICATE_ID, CANDIDATE_CERTIFICATE_ID);
  }
    ...
    void shallThrowIfUserIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              ...
              () -> validator.validate(request, CERTIFICATE_ID, CANDIDATE_CERTIFICATE_ID));
  ...
  class CertificateIdValidation {
    ...
    void shallThrowIfCertificateIdIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> validator.validate(request, null, CANDIDATE_CERTIFICATE_ID));
    ...
    void shallThrowIfCertificateIdIsEmpty() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> validator.validate(request, "", CANDIDATE_CERTIFICATE_ID));
  ...
  @Nested
  class CandidateCertificateIdValidation {

    @Test
    void shallThrowIfCandidateCertificateIdIsNull() {
      final var request = requestBuilder.build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> validator.validate(request, CERTIFICATE_ID, null));

      assertEquals(
          "Required parameter missing: candidateCertificateId",
          illegalArgumentException.getMessage());
    }

    @Test
    void shallThrowIfCandidateCertificateIdIsEmpty() {
      final var request = requestBuilder.build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
  ...
  void shallThrowIfTestIndicatedIsNull() {
    ...
    assertEquals(
        "Required parameter missing: Patient.testIndicated", illegalArgumentException.getMessage());
  }
