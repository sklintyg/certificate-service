...
class AnswerComplementRequestValidatorTest {

  private static final String CERTIFICATE_ID = "certificateId";
  private static final String MESSAGE = "message";
  private AnswerComplementRequestValidator answerComplementRequestValidator;
  private AnswerComplementRequest.AnswerComplementRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    answerComplementRequestValidator = new AnswerComplementRequestValidator();
    requestBuilder =
  ...
  @Test
  void validRequest() {
    answerComplementRequestValidator.validate(requestBuilder.build(), CERTIFICATE_ID);
  }
    ...
    void shallThrowIfUserIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              ...
              () -> answerComplementRequestValidator.validate(request, CERTIFICATE_ID));
  ...
  class CertificateIdValidation {
    ...
    void shallThrowIfCertificateIdIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> answerComplementRequestValidator.validate(request, null));
    ...
    void shallThrowIfCertificateIdIsEmpty() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> answerComplementRequestValidator.validate(request, ""));
  ...
  class MessageValidation {
    ...
    @Test
    void shallThrowIfMessageIsNull() {
      final var request = requestBuilder.message(null).build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> answerComplementRequestValidator.validate(request, CERTIFICATE_ID));

      assertEquals("Required parameter missing: message", illegalArgumentException.getMessage());
    }

    @Test
    void shallThrowIfMessageIsEmpty() {
      final var request = requestBuilder.message("").build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class,
              () -> answerComplementRequestValidator.validate(request, CERTIFICATE_ID));
