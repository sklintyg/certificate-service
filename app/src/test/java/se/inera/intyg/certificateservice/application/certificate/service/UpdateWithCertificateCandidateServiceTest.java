...
class UpdateWithCertificateCandidateServiceTest {
  ...
  @Mock
  private UpdateWithCertificateCandidateRequestValidator
      updateWithCertificateCandidateRequestValidator;
  ...
  @InjectMocks private UpdateWithCertificateCandidateService updateWithCertificateCandidateService;

  @Test
  void shallThrowIfRequestIsInvalid() {
    final var request = UpdateWithCertificateCandidateRequest.builder().build();
    doThrow(IllegalArgumentException.class)
        .when(updateWithCertificateCandidateRequestValidator)
        .validate(request, CERTIFICATE_ID, CANDIDATE_CERTIFICATE_ID);
    assertThrows(
        IllegalArgumentException.class,
        () ->
            updateWithCertificateCandidateService.update(
                request, CERTIFICATE_ID, CANDIDATE_CERTIFICATE_ID));
  }
  ...
  void shallReturnResponseWithCertificate() {
    ...
    final var expectedResponse =
        UpdateWithCertificateCandidateResponse.builder().certificate(certificateDTO).build();
    ...
    doReturn(certificate)
        .when(updateWithCertificateCandidateDomainService)
        .update(
