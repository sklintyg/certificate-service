...
class RevokeCertificateRequestValidatorTest {
  ...
  private RevokeCertificateRequestValidator validator;
  private RevokeCertificateRequest.RevokeCertificateRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    validator = new RevokeCertificateRequestValidator();
    requestBuilder =
  ...
  class RevokeInformationValidation {
    ...
    void shallThrowIfRevokeReasonIsNull() {
      final var request =
          requestBuilder.revoked(RevokeInformationDTO.builder().reason(null).build()).build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> validator.validate(request, CERTIFICATE_ID));

      assertEquals(
          "Required parameter missing: revoke.reason", illegalArgumentException.getMessage());
    }

    @Test
    void shallThrowIfRevokeReasonIsEmpty() {
      final var request =
          requestBuilder.revoked(RevokeInformationDTO.builder().reason("").build()).build();
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> validator.validate(request, CERTIFICATE_ID));
    ...
    void shallThrowIfRevokeReasonIsOtherSeriousErrorAndMessageIsNull() {
      ...
      assertEquals(
          "Required parameter missing: revoke.message", illegalArgumentException.getMessage());
    }
