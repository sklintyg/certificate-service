...
class GetCertificateCandidateServiceTest {

  private static final String CERTIFICATE_ID = "certificateId";
  @Mock private ActionEvaluationFactory actionEvaluationFactory;
  @Mock private GetCertificateCandidateRequestValidator getCertificateCandidateRequestValidator;
  @Mock private GetCertificateCandidateDomainService getCertificateCandidateDomainService;
  @Mock private CertificateConverter certificateConverter;
  @Mock private ResourceLinkConverter resourceLinkConverter;
  @InjectMocks private GetCertificateCandidateService getCertificateCandidateService;

  @Test
  void shallThrowIfRequestIsInvalid() {
    final var request = GetCertificateCandidateRequest.builder().build();
    doThrow(IllegalArgumentException.class)
        .when(getCertificateCandidateRequestValidator)
        .validate(request, CERTIFICATE_ID);
    assertThrows(
        IllegalArgumentException.class,
        () -> getCertificateCandidateService.get(request, CERTIFICATE_ID));
  }
  ...
  void shallReturnResponseWithCertificate() {
    ...
    final var expectedResponse =
        GetCertificateCandidateResponse.builder().certificate(certificateDTO).build();
    ...
    doReturn(Optional.of(certificate))
        .when(getCertificateCandidateDomainService)
    ...
    final var actualResult =
        getCertificateCandidateService.get(
            GetCertificateCandidateRequest.builder()
  ...
  @Test
  void shallReturnResponseWithoutCertificateWhenNoCandidate() {
    final var expectedResponse = GetCertificateCandidateResponse.builder().build();
