...
class GetUnitCertificatesServiceTest {
  ...
  @Mock private GetUnitCertificatesRequestValidator getUnitCertificatesRequestValidator;
  @Mock private ActionEvaluationFactory actionEvaluationFactory;
  @Mock private GetUnitCertificatesDomainService getUnitCertificatesDomainService;
  @Mock private ResourceLinkConverter resourceLinkConverter;
  @Mock private CertificateConverter certificateConverter;
  @InjectMocks private GetUnitCertificatesService getUnitCertificatesService;

  private static final CertificatesQueryCriteriaDTO QUERY_CRITERIA_DTO =
  ...
  void shallThrowIfInvalidRequest() {
    ...
    doThrow(IllegalArgumentException.class)
        .when(getUnitCertificatesRequestValidator)
        .validate(request);
  ...
  void shallReturnGetUnitCertificatesResponse() {
    ...
    final var expectedResponse =
        GetUnitCertificatesResponse.builder().certificates(List.of(certificateDTO)).build();
    ...
    doReturn(List.of(certificate))
        .when(getUnitCertificatesDomainService)
    ...
    final var actualResult =
        getUnitCertificatesService.get(
