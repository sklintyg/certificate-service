...
class SaveMessageRequestValidatorTest {
  ...
  private SaveMessageRequestValidator requestValidator;
  private SaveMessageRequest.SaveMessageRequestBuilder requestBuilder;

  @BeforeEach
  void setUp() {
    requestValidator = new SaveMessageRequestValidator();
    requestBuilder =
        SaveMessageRequest.builder()
            ...
            .question(QuestionDTO.builder().type(QuestionTypeDTO.CONTACT).build());
  }
  ...
  class UserValidation {
    ...
    void shallThrowIfUserIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> requestValidator.validate(request, MESSAGE_ID));
  ...
  class CertificateIdValidation {
    ...
    void shallThrowIfCertificateIdIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> requestValidator.validate(request, null));

      assertEquals("Required parameter missing: messageId", illegalArgumentException.getMessage());
    }
    ...
    void shallThrowIfCertificateIdIsEmpty() {
      ...
      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> requestValidator.validate(request, ""));
  ...
  class QuestionValidation {
    ...
    void shallThrowIfQuestionIsNull() {
      final var request = requestBuilder.question(null).build();

      final var illegalArgumentException =
          assertThrows(
              IllegalArgumentException.class, () -> requestValidator.validate(request, MESSAGE_ID));

      assertEquals("Required parameter missing: Question", illegalArgumentException.getMessage());
    }

    @Test
    void shallThrowIfQuestionTypeIsNull() {
      final var request = requestBuilder.question(QuestionDTO.builder().type(null).build()).build();
      ...
      assertEquals(
          "Required parameter missing: Question.type", illegalArgumentException.getMessage());
    }
  }
}
