...
public class FK3226V1_1TextProvider implements CertificateTextProvider {
  ...
  public String text(Enum<?> key) {
    return switch ((FK3226TextKey) key) {
      ...
      case QUESTION_PATIENTENS_VARDSITUATION_NAME -> "Patientens vårdsituation";
      ...
      case CODE_ENDAST_PALLIATIV -> CodeSystemKvFkmu0009.ENDAST_PALLIATIV_V2.displayName();
    };
  }
  ...
  public Code code(Enum<?> key) {
    return switch ((FK3226TextKey) key) {
      case CODE_ENDAST_PALLIATIV -> CodeSystemKvFkmu0009.ENDAST_PALLIATIV_V2;
