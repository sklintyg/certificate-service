...
public class CategoryVardEllerTillsyn {
  ...
  public static ElementSpecification categoryVardEllerTillsyn(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(VARD_ELLER_TILLSYN_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Vård eller tillsyn").build())
