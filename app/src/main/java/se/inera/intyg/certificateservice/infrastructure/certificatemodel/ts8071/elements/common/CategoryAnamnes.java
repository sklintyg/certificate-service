...
public class CategoryAnamnes {
  ...
  public static ElementSpecification categoryAnamnes(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(INTYGET_ANAMNES_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Anamnesfrågor").build())
        .rules(
            List.of(
