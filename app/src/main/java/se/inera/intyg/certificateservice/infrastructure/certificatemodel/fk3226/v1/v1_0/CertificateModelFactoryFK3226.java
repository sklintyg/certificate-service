 ...
 */
package se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.v1_0;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.CategoryGrund.categoryGrund;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.CategoryHot.categoryHot;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.CategorySamtycke.categorySamtycke;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.MessageForutsattningarForAttLamnaSkriftligtSamtycke.messageForutsattningarForAttLamnaSkriftligtSamtycke;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.questionDiagnos;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionForutsattningarForAttLamnaSkriftligtSamtycke.questionForutsattningarForAttLamnaSkriftligtSamtycke;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionNarAktivaBehandlingenAvslutades.questionNarAktivaBehandlingenAvslutades;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionNarTillstandetBlevAkutLivshotande.questionNarTillstandetBlevAkutLivshotande;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionPatientensBehandlingOchVardsituation.questionPatientBehandlingOchVardsituation;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionTillstandetUppskattasLivshotandeTillOchMed.questionTillstandetUppskattasLivshotandeTillOchMed;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUppskattaHurLangeTillstandetKommerVaraLivshotande.questionUppskattaHurLangeTillstandetKommerVaraLivshotande;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.questionUtlatandeBaseratPa;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPaAnnat.questionUtlatandeBaseratPaAnnat;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.v1_0.elements.QuestionPatagligtHotMotPatientensLivAkutLivshotandeV1.questionPatagligtHotMotPatientensLivAkutLivshotande;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.v1_0.elements.QuestionPatagligtHotMotPatientensLivAnnatV1.questionPatagligtHotMotPatientensLivAnnat;
...
import se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.FK3226CertificateActionSpecification;
import se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.FK3226CertificateSummaryProvider;
import se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.FK3226MessageActionSpecification;
...
public class CertificateModelFactoryFK3226 implements CertificateModelFactory {
  ...
  public CertificateModel create() {
    final var texts = new FK3226V1TextProvider();
    final var printTags = new FK3226V1PrintTagProvider();
    return CertificateModel.builder()
        ...
        .elementSpecifications(
            List.of(
                categoryGrund(
                    questionUtlatandeBaseratPa(printTags, questionUtlatandeBaseratPaAnnat())),
                categoryHot(
                    texts,
                    questionDiagnos(diagnosisCodeRepository),
                    questionPatientBehandlingOchVardsituation(
                        texts,
                        questionNarAktivaBehandlingenAvslutades(texts, printTags),
                        questionNarTillstandetBlevAkutLivshotande(printTags),
