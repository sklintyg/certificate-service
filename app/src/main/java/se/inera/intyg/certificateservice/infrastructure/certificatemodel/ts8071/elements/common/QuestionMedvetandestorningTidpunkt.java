...
public class QuestionMedvetandestorningTidpunkt {
  ...
  public static final ElementId QUESTION_MEDVETANDESTORNING_TIDPUNKT_ID = new ElementId("14.9");
  public static final FieldId QUESTION_MEDVETANDESTORNING_TIDPUNKT_FIELD_ID = new FieldId("14.9");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_MEDVETANDESTORNING_TIDPUNKT_ID, (short) 50)))
        .shouldValidate(ElementDataPredicateFactory.valueBoolean(QUESTION_MEDVETANDESTORNING_ID))
