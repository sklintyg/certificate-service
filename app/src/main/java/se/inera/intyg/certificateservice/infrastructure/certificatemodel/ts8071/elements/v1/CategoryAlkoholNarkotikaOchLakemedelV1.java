...
public class CategoryAlkoholNarkotikaOchLakemedelV1 {
  ...
  private static final ElementId INTYGET_ALKOHOL_NARKOTIKA_OCH_LAKEMEDEL_CATEGORY_V1_ID =
      new ElementId("KAT_12");
  ...
  public static ElementSpecification categoryAlkoholNarkotikaOchLakemedelV1(
    ...
    return ElementSpecification.builder()
        ...
        .configuration(
            ElementConfigurationCategory.builder().name("Alkohol, narkotika och läkemedel").build())
