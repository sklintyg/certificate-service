...
@Repository
public interface MessageRelationEntityRepository
    extends CrudRepository<MessageRelationEntity, Long> {

  List<MessageRelationEntity> findByParentMessage(MessageEntity messageEntity);
