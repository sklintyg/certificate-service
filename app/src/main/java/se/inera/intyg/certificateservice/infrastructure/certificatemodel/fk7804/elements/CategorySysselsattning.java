...
public class CategorySysselsattning {
  ...
  public static final ElementId CATEGORY_ID = new ElementId("KAT_3");

  private CategorySysselsattning() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification categorySysselsattning(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Sysselsättning").build())
        .rules(
            List.of(
