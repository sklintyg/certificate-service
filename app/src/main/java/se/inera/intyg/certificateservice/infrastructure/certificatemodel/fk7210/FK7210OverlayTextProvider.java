...
public class FK7210OverlayTextProvider implements OverlayTextProvider {
  ...
  @Override
  public List<OverlayText> of(
      Certificate certificate, PdfTagIndex tagIndex, PdfGeneratorOptions options) {
  ...
  private static OverlayText sentText(String recipientName) {
    return OverlayText.builder()
        ...
        .x(SENT_TEXT_X)
        .y(SENT_TEXT_Y)
        .appearance(new Appearance(SENT_TEXT_FONT_SIZE, null))
        .pageIndex(0)
        .build();
  }
  ...
  private static OverlayText citizenVisibilityText() {
    return OverlayText.builder()
        ...
        .appearance(new Appearance(CITIZEN_VISIBILITY_TEXT_FONT_SIZE, null))
        .pageIndex(0)
        .build();
  }
}
