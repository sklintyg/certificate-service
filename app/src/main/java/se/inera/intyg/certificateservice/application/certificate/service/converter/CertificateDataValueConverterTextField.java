...
@Component
public class CertificateDataValueConverterTextField implements CertificateDataValueConverter {
  ...
  public CertificateDataValue convert(
    ...
    if (!(elementSpecification.configuration()
        instanceof ElementConfigurationTextField elementConfiguration)) {
      throw new IllegalStateException(
