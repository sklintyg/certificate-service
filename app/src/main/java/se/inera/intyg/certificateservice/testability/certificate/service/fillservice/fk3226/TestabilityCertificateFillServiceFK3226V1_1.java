...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOSIS_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOS_1;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOS_2;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOS_3;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOS_4;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionDiagnos.DIAGNOS_5;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionForutsattningarForAttLamnaSkriftligtSamtycke.FORUTSATTNINGAR_FOR_ATT_LAMNA_SKRIFTLIGT_SAMTYCKE_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionNarAktivaBehandlingenAvslutades.QUESTION_NAR_AKTIVA_BEHANDLINGEN_AVSLUTADES_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionNarTillstandetBlevAkutLivshotande.QUESTION_NAR_TILLSTANDET_BLEV_AKUT_LIVSHOTANDE_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionTillstandetUppskattasLivshotandeTillOchMed.QUESTION_TILLSTANDET_UPPSKATTAS_LIVSHOTANDE_TILL_OCH_MED_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUppskattaHurLangeTillstandetKommerVaraLivshotande.QUESTION_UPSKATTA_HUR_LANGE_TILLSTANDET_KOMMER_VARA_LIVSHOTANDE_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.QUESTION_UTLATANDE_BASERAT_PA_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.UTLATANDE_BASERAT_PA_ANNAT_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.UTLATANDE_BASERAT_PA_JOURNALUPPGIFTER_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.UTLATANDE_BASERAT_PA_UNDERSOKNING_AV_PATIENTEN_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPaAnnat.QUESTION_UTLATANDE_BASERAT_PA_ANNAT_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.v1_1.CertificateModelFactoryFK3226V1_1.FK3226_V1_1;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.v1_1.elements.QuestionPatagligtHotMotPatientensLivAkutLivshotandeV1_1.QUESTION_PATAGLIGT_HOT_MOT_PATIENTENS_LIV_AKUT_LIVSHOTANDE_ID;
