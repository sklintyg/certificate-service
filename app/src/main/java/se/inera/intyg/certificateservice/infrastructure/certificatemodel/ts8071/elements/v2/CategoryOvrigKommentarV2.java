...
public class CategoryOvrigKommentarV2 {
  ...
  private static final ElementId INTYGET_OVRIG_KOMMENTAR_V2_CATEGORY_ID = new ElementId("KAT_16");

  private CategoryOvrigKommentarV2() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification categoryOvrigKommentarV2(ElementSpecification... children) {
