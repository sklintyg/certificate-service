...
public class CategoryIdentitet {
  ...
  private static final ElementId IDENTITET_CATEGORY_ID = new ElementId("KAT_0.2");

  private CategoryIdentitet() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification categoryIdentitet(ElementSpecification... children) {
