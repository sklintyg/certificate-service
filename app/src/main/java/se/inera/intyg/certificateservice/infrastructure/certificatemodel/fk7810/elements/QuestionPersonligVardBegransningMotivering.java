...
public class QuestionPersonligVardBegransningMotivering
    extends AbstractAktivitetsbegransningMotivering {

  public static final ElementId AKTIVITETSBEGRANSNING_MOTIVERING_PERSONLIG_VARD_BEGRANSNING_ID =
      new ElementId("68");
  private static final FieldId
      AKTIVITETSBEGRANSNING_MOTIVERING_PERSONLIG_VARD_BEGRANSNING_FIELD_ID = new FieldId("68.1");
  private static final PdfFieldId PDF_FIELD_ID =
      new PdfFieldId("form1[0].Sida4[0].flt_txtPersonligVard[0]");
