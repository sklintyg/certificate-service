...
public class CertificateModelFactoryTS8071V2 implements CertificateModelFactory {
  ...
  public static final CertificateModelId TS8071_V2_0 =
    ...
    return CertificateModel.builder()
        ...
        .elementSpecifications(
            List.of(
                ...
                categorySynskarpa(
                    questionSynskarpa(), questionToleransKorrektionV2(questionGlasogonStyrkaV2())),
                categoryAnamnes(
                    questionSjukdomEllerSynnedsattning(
                        questionSjukdomEllerSynnedsattningBeskrivningV2()),
                    questionSjukdomshistorik(questionSjukdomshistorikBeskrivningV2())),
                categoryBalanssinne(questionBalanssinne(questionBalanssinneBeskrivningV2())),
                categoryHorselV2(
                    questionHorselV2(),
                    questionHorselhjalpmedelV2(questionHorselhjalpmedelPositionV2())),
                ...
                categoryHjartOchKarlsjukdomar(
                    questionHjartsjukdom(questionHjartsjukdomBeskrivningV2()),
                    questionHjartsjukdomBehandlad(questionHjartsjukdomBehandladBeskrivningV2()),
                    questionArytmi(questionArytmiBeskrivning()),
                    questionSynkopeV2(
                        questionSynkopeBeskrivning(
                            QUESTION_SYNKOPE_V2_ID, QUESTION_SYNKOPE_V2_FIELD_ID)),
                    questionStrokeV2(questionStrokePaverkanV2())),
                categoryDiabetes(questionDiabetesV2(), messageDiabetesV2()),
                categoryNeurologiskaSjukdomar(
                    questionNeurologiskSjukdomV2(questionNeurologiskSjukdomBeskrivningV2())),
                categoryEpilepsi(
                    ...
                    questionEpilepsiMedicin(
                        questionEpilepsiMedicinBeskrivning(), questionEpilepsiMedicinTidpunktV2()),
                ...
                categoryDemensOchAndraKognitivaStorningar(
                    questionKognitivStorningV2(), questionDemensV2(questionDemensBeskrivningV2())),
                ...
                categoryAlkoholOchLakemedelV2(
                    questionMissbrukV2(
                        questionMissbrukBeskrivningV2(), questionMissbrukRemissionV2()),
                    ...
                    questionMissbrukVardV2(questionMissbrukVardBeskrivningV2()),
                    questionLakemedelV2(questionLakemedelBeskrivningV2())),
                categoryPsykiskaSjukdomarOchStorningar(
                    questionPsykiskV2(
                        questionPsykiskBeskrivning(
                            QUESTION_PSYKISK_V2_ID, QUESTION_PSYKISK_V2_FIELD_ID),
                ...
                categoryOvrigMedicinering(
                    questionMedicinering(questionMedicineringBeskrivningV2())),
                categoryOvrigKommentarV2(questionOvrigBeskrivning()),
                categoryBedomning(
                    questionBedomning(questionBedomningRiskV2(), questionBedomningOkand())),
