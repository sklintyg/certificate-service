...
@Component
public class CertificateDataValueConverterRadioBoolean implements CertificateDataValueConverter {
  ...
  public CertificateDataValue convert(
    ...
    if (!(elementSpecification.configuration()
        instanceof ElementConfigurationRadioBoolean elementConfigurationRadioBoolean)) {
      throw new IllegalStateException(
