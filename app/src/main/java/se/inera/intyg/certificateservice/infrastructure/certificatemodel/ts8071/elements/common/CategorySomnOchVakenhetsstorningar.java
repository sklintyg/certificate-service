...
public class CategorySomnOchVakenhetsstorningar {
  ...
  private static final ElementId INTYGET_SOMN_OCH_VAKENHETSSTORNINGAR_CATEGORY_ID =
      new ElementId("KAT_11");
  ...
  public static ElementSpecification categorySomnOchVakenhetsstorningar(
    ...
    return ElementSpecification.builder()
        ...
        .configuration(
            ElementConfigurationCategory.builder().name("Sömn- och vakenhetsstörningar").build())
