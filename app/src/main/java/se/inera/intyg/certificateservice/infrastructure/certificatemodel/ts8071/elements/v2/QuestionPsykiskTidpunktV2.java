        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.mandatory(
                    QUESTION_PSYKISK_TIDPUNKT_V2_ID, QUESTION_PSYKISK_TIDPUNKT_V2_FIELD_ID),
                CertificateElementRuleFactory.limit(QUESTION_PSYKISK_TIDPUNKT_V2_ID, (short) 50)))
        .shouldValidate(ElementDataPredicateFactory.valueBoolean(QUESTION_PSYKISK_V2_ID))
        .mapping(new ElementMapping(QUESTION_PSYKISK_V2_ID, null))
