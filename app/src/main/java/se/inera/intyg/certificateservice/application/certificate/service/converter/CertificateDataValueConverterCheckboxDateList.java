...
@Component
public class CertificateDataValueConverterCheckboxDateList
  ...
  public CertificateDataValue convert(
    ...
    if (!(elementSpecification.configuration()
        instanceof
        ElementConfigurationCheckboxMultipleDate elementConfigurationCheckboxMultipleDate)) {
      throw new IllegalStateException(
    ...
    return CertificateDataValueDateList.builder()
        ...
        .list(
            isValueDefined(elementValue)
                ? ((ElementValueDateList) elementValue)
                    .dateList().stream()
                        .map(
                            date ->
