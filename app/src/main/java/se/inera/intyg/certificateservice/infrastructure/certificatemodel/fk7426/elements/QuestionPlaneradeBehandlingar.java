...
public class QuestionPlaneradeBehandlingar {
  ...
  private static final FieldId QUESTION_PLANERADE_BEHANDLING_FIELD_ID = new FieldId("20.1");
  private static final PdfFieldId PDF_FIELD_ID =
      new PdfFieldId("form1[0].#subform[2].flt_txt_PlaneradeMedicinska[0]");
        ...
        .rules(
            List.of(
                CertificateElementRuleFactory.limit(
                    QUESTION_PLANERADE_BEHANDLING_ID, TEXT_FIELD_LIMIT)))
        .validations(
            List.of(
