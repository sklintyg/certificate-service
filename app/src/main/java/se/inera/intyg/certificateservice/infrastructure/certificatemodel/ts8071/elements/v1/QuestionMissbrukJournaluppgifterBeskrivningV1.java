...
public class QuestionMissbrukJournaluppgifterBeskrivningV1 {
  ...
  public static final ElementId QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_V1_ID =
      new ElementId("18.4");
  public static final FieldId QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_V1_FIELD_ID =
      new FieldId("18.4");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_V1_ID, (short) 50)))
        .shouldValidate(
