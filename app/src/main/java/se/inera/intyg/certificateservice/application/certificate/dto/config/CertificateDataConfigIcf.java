...
import lombok.Value;
import se.inera.intyg.certificateservice.application.certificate.dto.config.CertificateDataConfigIcf.CertificateDataConfigIcfBuilder;
...
public class CertificateDataConfigIcf implements CertificateDataConfig {
  ...
  String placeholder;
  IcfCodesPropertyTypeDTO icfCodesPropertyName;
