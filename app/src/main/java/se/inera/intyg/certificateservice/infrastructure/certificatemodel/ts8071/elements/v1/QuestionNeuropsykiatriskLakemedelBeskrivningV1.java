...
public class QuestionNeuropsykiatriskLakemedelBeskrivningV1 {
  ...
  public static final ElementId QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_BESKRIVNING_V1_ID =
      new ElementId("20.5");
  public static final FieldId QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_BESKRIVNING_FIELD_V1_ID =
      new FieldId("20.5");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_BESKRIVNING_V1_ID, (short) 50)))
        .shouldValidate(
