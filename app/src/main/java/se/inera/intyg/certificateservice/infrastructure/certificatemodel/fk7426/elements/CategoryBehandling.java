...
public class CategoryBehandling {
  ...
  public static ElementSpecification categoryBehandling(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(BEHANDLING_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Behandling").build())
