...
@EqualsAndHashCode
public class FK7472PdfTagProvider implements PdfTagIndexProvider {
  ...
  public PdfTagIndex of(Certificate certificate, PdfGeneratorOptions options) {
    return includeAddress(certificate, options)
        ? PDF_SIGNATURE_WITH_ADDRESS_TAG_INDEX
        : PDF_SIGNATURE_WITHOUT_ADDRESS_TAG_INDEX;
  }
