...
public class FK7472PdfSpecification {
  ...
  private static final float PDF_SIGNATURE_TEXT_Y = 268f;
  ...
  private static final PdfFieldId PDF_PA_TITLE_FIELD_ID =
      new PdfFieldId("form1[0].#subform[0].flt_txtBefattning[0]");
  private static final PdfFieldId PDF_SPECIALTY_FIELD_ID =
