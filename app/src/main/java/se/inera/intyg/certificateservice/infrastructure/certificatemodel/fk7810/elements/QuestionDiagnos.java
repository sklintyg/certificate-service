...
public class QuestionDiagnos {
  ...
  private static final PdfFieldId PDF_DIAGNOSIS_ID_1 =
      new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos[0]");
  ...
  private static final PdfFieldId PDF_DIAGNOSIS_ID_2 =
      new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos2[0]");
  ...
  private static final PdfFieldId PDF_DIAGNOSIS_ID_3 =
      new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos3[0]");
  ...
  private static final PdfFieldId PDF_DIAGNOSIS_ID_4 =
      new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos4[0]");
  ...
  private static final PdfFieldId PDF_DIAGNOSIS_ID_5 =
      new PdfFieldId("form1[0].Sida2[0].flt_txtDiagnos5[0]");
