...
public class FK7427PdfSpecification {
  ...
  private static final PdfFieldId PDF_SIGNED_DATE_FIELD_ID =
      new PdfFieldId("form1[0].#subform[2].flt_datUnderskrift[0]");
  private static final PdfFieldId PDF_SIGNED_BY_NAME_FIELD_ID =
      new PdfFieldId("form1[0].#subform[2].flt_txtNamnfortydligande[0]");
  private static final PdfFieldId PDF_SIGNED_BY_PA_TITLE =
      new PdfFieldId("form1[0].#subform[2].flt_txtBefattning[0]");
  ...
  private static final PdfFieldId PDF_HSA_ID_FIELD_ID =
      new PdfFieldId("form1[0].#subform[2].flt_txtLakarensHSA-ID[0]");
  private static final PdfFieldId PDF_WORKPLACE_CODE_FIELD_ID =
      new PdfFieldId("form1[0].#subform[2].flt_txtArbetsplatskod[0]");
