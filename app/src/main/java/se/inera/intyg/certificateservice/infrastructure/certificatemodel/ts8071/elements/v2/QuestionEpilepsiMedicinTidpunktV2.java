...
public class QuestionEpilepsiMedicinTidpunktV2 {

  public static final ElementId QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_ID = new ElementId("14.7");
  public static final FieldId QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_FIELD_ID = new FieldId("14.7");

  private QuestionEpilepsiMedicinTidpunktV2() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification questionEpilepsiMedicinTidpunktV2() {
    return ElementSpecification.builder()
        .id(QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_ID)
        .configuration(
            ElementConfigurationTextField.builder()
                .id(QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_FIELD_ID)
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_ID, (short) 50)))
