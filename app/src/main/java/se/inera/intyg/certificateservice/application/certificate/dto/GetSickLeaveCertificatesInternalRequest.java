...
public class GetSickLeaveCertificatesInternalRequest {
  ...
  @Builder.Default List<String> certificateTypes = List.of();
  LocalDate signedFrom;
  LocalDate signedTo;
  @Builder.Default List<String> issuedByUnitIds = List.of();
  @Builder.Default List<String> issuedByStaffIds = List.of();
