...
public class CategoryArbetsformaga {
  ...
  public static ElementSpecification categoryArbetsformaga(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(CATEGORY_ARBETSFORMAGA_ID)
        .configuration(ElementConfigurationCategory.builder().name("Arbetsförmåga").build())
