...
public class CategorySymptom {
  ...
  public static ElementSpecification categorySymptom(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(QUESTION_SYMPTOM_CATEGORY_ID)
        .configuration(
            ElementConfigurationCategory.builder().name("Barnets diagnos eller symtom").build())
