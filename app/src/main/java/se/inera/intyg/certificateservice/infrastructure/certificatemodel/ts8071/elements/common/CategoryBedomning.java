...
public class CategoryBedomning {
  ...
  private static final ElementId INTYGET_BEDOMNING_CATEGORY_ID = new ElementId("KAT_17");
  ...
  public static ElementSpecification categoryBedomning(ElementSpecification... children) {
    return ElementSpecification.builder()
        ...
        .configuration(ElementConfigurationCategory.builder().name("Bedömning").build())
