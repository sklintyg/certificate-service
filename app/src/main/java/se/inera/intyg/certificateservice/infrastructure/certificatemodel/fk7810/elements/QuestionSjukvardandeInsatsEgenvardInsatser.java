...
public class QuestionSjukvardandeInsatsEgenvardInsatser {
  ...
  public static final ElementId QUESTION_SJUKVARDANDE_INSATS_EGENVARD_INSATSER_ID =
      new ElementId("70.4");
  private static final FieldId QUESTION_SJUKVARDANDE_INSATS_EGENVARD_INSATSER_FIELD_ID =
      new FieldId("70.4");
  private static final PdfFieldId PDF_FIELD_ID =
      new PdfFieldId("form1[0].#subform[5].flt_txtVilkaInsatserOmfattning2[0]");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_SJUKVARDANDE_INSATS_EGENVARD_INSATSER_ID, (short) 4000),
