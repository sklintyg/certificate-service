...
public class QuestionNeurologiskSjukdomBeskrivningV2 {
  ...
  public static final ElementId QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V2_ID =
      new ElementId("13.2");
  public static final FieldId QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V2_FIELD_ID =
      new FieldId("13.2");
  ...
  public static ElementSpecification questionNeurologiskSjukdomBeskrivningV2() {
    return ElementSpecification.builder()
        ...
        .rules(
            List.of(
                CertificateElementRuleFactory.show(
                    QUESTION_NEUROLOGISK_SJUKDOM_V2_ID, QUESTION_NEUROLOGISK_SJUKDOM_V2_FIELD_ID),
        ...
        .mapping(new ElementMapping(QUESTION_NEUROLOGISK_SJUKDOM_V2_ID, null))
        .validations(
