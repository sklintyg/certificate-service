...
import se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.FK3226PrintTagKey;
...
public class QuestionUtlatandeBaseratPa {
  ...
  public static ElementSpecification questionUtlatandeBaseratPa(
      CertificatePrintTagProvider printTags, ElementSpecification... children) {
                    ...
                    Map.of(
                        ...
                        PdfConfigurationDateCheckbox.builder()
                            ...
                            .dateFieldId(
                                printTags.fieldId(
                                    FK3226PrintTagKey
                                        .QUESTION_UTLATANDE_BASERAT_PA_INVESTIGATION_DATE))
                            .build(),
                        ...
                        PdfConfigurationDateCheckbox.builder()
                            ...
                            .dateFieldId(
                                printTags.fieldId(
                                    FK3226PrintTagKey.QUESTION_UTLATANDE_BASERAT_PA_JOURNAL_DATE))
                            .build(),
                        ...
                        PdfConfigurationDateCheckbox.builder()
                            ...
                            .dateFieldId(
                                printTags.fieldId(
                                    FK3226PrintTagKey.QUESTION_UTLATANDE_BASERAT_PA_OTHER_DATE))
                            .build()))
                .build())
