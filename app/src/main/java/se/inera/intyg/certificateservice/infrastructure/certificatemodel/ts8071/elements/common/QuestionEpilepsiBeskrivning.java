...
public class QuestionEpilepsiBeskrivning {
  ...
  public static final ElementId QUESTION_EPILEPSI_BESKRIVNING_ID = new ElementId("14.2");
  public static final FieldId QUESTION_EPILEPSI_BESKRIVNING_FIELD_ID = new FieldId("14.2");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.mandatory(
                    QUESTION_EPILEPSI_BESKRIVNING_ID, QUESTION_EPILEPSI_BESKRIVNING_FIELD_ID),
                CertificateElementRuleFactory.limit(QUESTION_EPILEPSI_BESKRIVNING_ID, (short) 50)))
