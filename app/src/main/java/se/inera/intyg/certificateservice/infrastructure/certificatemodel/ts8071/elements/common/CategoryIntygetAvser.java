...
public class CategoryIntygetAvser {
  ...
  public static ElementSpecification categoryIntygetAvser(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(INTYGET_AVSER_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Intyget avser").build())
