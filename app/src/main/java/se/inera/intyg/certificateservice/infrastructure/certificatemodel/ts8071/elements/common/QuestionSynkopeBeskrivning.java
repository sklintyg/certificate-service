...
public class QuestionSynkopeBeskrivning {
  ...
  public static final ElementId QUESTION_SYNKOPE_BESKRIVNING_ID = new ElementId("11.8");
  public static final FieldId QUESTION_SYNKOPE_BESKRIVNING_FIELD_ID = new FieldId("11.8");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.mandatory(
                    QUESTION_SYNKOPE_BESKRIVNING_ID, QUESTION_SYNKOPE_BESKRIVNING_FIELD_ID),
                CertificateElementRuleFactory.limit(QUESTION_SYNKOPE_BESKRIVNING_ID, (short) 50)))
