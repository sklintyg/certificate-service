...
public class QuestionPeriodInneliggandePaSjukhus {
  ...
  private static final PdfFieldId PDF_FIELD_ID_FROM =
      new PdfFieldId("form1[0].#subform[2].flt_datumFranMed2[0]");
  private static final PdfFieldId PDF_FIELD_ID_TO =
      new PdfFieldId("form1[0].#subform[2].flt_datumTillMed2[0]");
        ...
        .rules(
            List.of(
                CertificateElementRuleFactory.mandatory(
                    QUESTION_PERIOD_INNELIGGANDE_ID, QUESTION_PERIOD_INNELIGGANDE_FIELD_ID),
