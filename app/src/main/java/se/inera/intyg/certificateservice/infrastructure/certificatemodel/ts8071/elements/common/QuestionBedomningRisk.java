...
public class QuestionBedomningRisk {
  ...
  public static final ElementId QUESTION_BEDOMNING_RISK_ID = new ElementId("23.3");
  private static final FieldId QUESTION_BEDOMNING_RISK_FIELD_ID = new FieldId("23.3");
        ...
        .rules(
            List.of(
                CertificateElementRuleFactory.mandatory(
                    QUESTION_BEDOMNING_RISK_ID, QUESTION_BEDOMNING_RISK_FIELD_ID),
                CertificateElementRuleFactory.show(
                    QUESTION_BEDOMNING_ID, new RuleExpression(String.format("$%s", YES.code()))),
                CertificateElementRuleFactory.limit(QUESTION_BEDOMNING_RISK_ID, (short) 50)))
        .validations(List.of(ElementValidationText.builder().mandatory(true).limit(50).build()))
        .shouldValidate(
            ElementDataPredicateFactory.codes(
                QUESTION_BEDOMNING_ID, List.of(new FieldId(YES.code()))))
