...
public class CategoryRorelseorganensFunktioner {
  ...
  private static final ElementId INTYGET_RORELSEORGANENS_FUNKTIONER_CATEGORY_ID =
      new ElementId("KAT_4");
  ...
  public static ElementSpecification categoryRorelseorganensFunktioner(
    ...
    return ElementSpecification.builder()
        ...
        .configuration(
            ElementConfigurationCategory.builder().name("Rörelseorganens funktioner").build())
