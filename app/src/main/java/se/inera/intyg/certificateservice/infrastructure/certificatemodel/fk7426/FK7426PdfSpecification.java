...
public class FK7426PdfSpecification {
  ...
  private static final float PDF_SIGNATURE_TEXT_Y = 408f;
  ...
  public static CustomPdfSpecification create() {
    return CustomPdfSpecification.builder()
        .pdfTemplatePathProvider(new FK7426TemplatePathProvider())
        ...
        .overlayTextProvider(
            new OverlayTextProvider(
                OverlayDetails.builder()
                    ...
                    .signaturePageIndex(PDF_SIGNATURE_PAGE_INDEX)
                    .signedTextWithAddressIndex(31)
                    .signedTextWithoutAddressIndex(31)
                    .sentTextIndex(3)
                    .citizenTextIndex(3)
                    .build()))
        .overflowFieldId(FORTSATTNINGSBLAD_ID)
