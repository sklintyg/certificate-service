...
public class QuestionStrokePaverkanV1 {
  ...
  public static final ElementId QUESTION_STROKE_PAVERKAN_V1_ID = new ElementId("11.10");
  public static final FieldId QUESTION_STROKE_PAVERKAN_FIELD_V1_ID = new FieldId("11.10");

  private QuestionStrokePaverkanV1() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification questionStrokePaverkanV1(ElementSpecification... children) {
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.show(
                    QUESTION_STROKE_V1_ID, QUESTION_STROKE_V1_FIELD_ID)))
