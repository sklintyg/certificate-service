...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionBalanssinneBeskrivningV2.QUESTION_BALANSSINNE_BESKRIVNING_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionHjartsjukdomBeskrivningV2.QUESTION_HJARTSJUKDOM_BESKRIVNING_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionHorselhjalpmedelPositionV2.QUESTION_HORSELHJALPMEDEL_POSITION_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionIntellektuellFunktionsnedsattningBeskrivningV2.QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_BESKRIVNING_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionLakemedelBeskrivningV2.QUESTION_LAKEMEDEL_BESKRIVNING_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMedicineringBeskrivningV2.QUESTION_MEDICINERING_BESKRIVNING_V2_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMissbrukBeskrivningV2.QUESTION_MISSBRUK_BESKRIVNING_V2_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMissbrukJournaluppgifterBeskrivningV2.QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMissbrukRemissionV2.QUESTION_MISSBRUK_REMISSION_V2_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMissbrukVardBeskrivningV2.QUESTION_MISSBRUK_VARD_BESKRIVNING_V2_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionMissbrukVardV2.QUESTION_MISSBRUK_VARD_V2_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v2.QuestionNeurologiskSjukdomBeskrivningV2.QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V2_ID;
...
@Component
public class TestabilityCertificateFillServiceTS8071V2
  ...
  private static final List<ElementId> MAXIMAL_IDS =
      List.of(
          ...
          QUESTION_TOLERANS_KORREKTION_V2_ID,
          ...
          QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_ID,
          ...
          QUESTION_MISSBRUK_VARD_BESKRIVNING_V2_ID,
  ...
  private static Code getCode(ElementId elementId, TestabilityFillTypeDTO fillType) {
    ...
    throw new IllegalStateException(
        String.format("Code not defined in TS8071V2 fill service for question %s", elementId.id()));
  }
}
