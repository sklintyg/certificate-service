...
public class CategoryIntygetBaseratPa {
  ...
  public static ElementSpecification categoryIntygetBaseratPa(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(INTYGET_BASERAT_PA_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Intyget är baserat på").build())
