...
public class CategoryBalanssinne {
  ...
  public static ElementSpecification categoryBalanssinne(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(INTYGET_BALANSSINNE_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Balanssinne").build())
