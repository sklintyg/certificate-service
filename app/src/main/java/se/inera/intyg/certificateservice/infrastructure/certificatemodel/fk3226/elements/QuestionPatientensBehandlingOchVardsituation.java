    ...
    final var radioMultipleCodes =
        List.of(
            new ElementConfigurationCode(
                ...
                texts.code(FK3226TextKey.CODE_ENDAST_PALLIATIV).displayName(),
                texts.code(FK3226TextKey.CODE_ENDAST_PALLIATIV)),
            new ElementConfigurationCode(
    ...
    return ElementSpecification.builder()
        ...
        .configuration(
            ElementConfigurationRadioMultipleCode.builder()
                ...
                .name(texts.text(FK3226TextKey.QUESTION_PATIENTENS_VARDSITUATION_NAME))
