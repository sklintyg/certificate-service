...
public class QuestionSjukdomEllerSynnedsattningBeskrivningV2 {
  ...
  public static final ElementId QUESTION_SJUKDOM_ELLER_SYNNEDSATTNING_BESKRIVNING_V2_ID =
      new ElementId("7.2");
  public static final FieldId QUESTION_SJUKDOM_ELLER_SYNNEDSATTNING_BESKRIVNING_V2_FIELD_ID =
      new FieldId("7.2");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_SJUKDOM_ELLER_SYNNEDSATTNING_BESKRIVNING_V2_ID, (short) 250)))
        .shouldValidate(
