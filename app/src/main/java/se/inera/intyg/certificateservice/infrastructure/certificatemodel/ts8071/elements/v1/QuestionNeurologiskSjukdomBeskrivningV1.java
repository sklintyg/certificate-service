...
public class QuestionNeurologiskSjukdomBeskrivningV1 {
  ...
  public static final ElementId QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V1_ID =
      new ElementId("13.2");
  public static final FieldId QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V1_FIELD_ID =
      new FieldId("13.2");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_V1_ID, (short) 50)))
        .shouldValidate(
            ElementDataPredicateFactory.valueBoolean(QUESTION_NEUROLOGISK_SJUKDOM_V1_ID))
        .mapping(new ElementMapping(QUESTION_NEUROLOGISK_SJUKDOM_V1_ID, null))
