...
public class QuestionBedomningOkand {
  ...
  public static final ElementId QUESTION_BEDOMNING_OKAND_ID = new ElementId("23.2");
  private static final FieldId QUESTION_BEDOMNING_OKAND_FIELD_ID = new FieldId("23.2");
        ...
        .rules(
            List.of(
                CertificateElementRuleFactory.mandatory(
                    QUESTION_BEDOMNING_OKAND_ID, QUESTION_BEDOMNING_OKAND_FIELD_ID),
                CertificateElementRuleFactory.show(
                    QUESTION_BEDOMNING_ID,
                    new RuleExpression(String.format("$%s", NO_DECISION.code()))),
                CertificateElementRuleFactory.limit(QUESTION_BEDOMNING_OKAND_ID, (short) 250)))
        .validations(List.of(ElementValidationText.builder().mandatory(true).limit(250).build()))
        .shouldValidate(
            ElementDataPredicateFactory.codes(
                QUESTION_BEDOMNING_ID, List.of(new FieldId(NO_DECISION.code()))))
