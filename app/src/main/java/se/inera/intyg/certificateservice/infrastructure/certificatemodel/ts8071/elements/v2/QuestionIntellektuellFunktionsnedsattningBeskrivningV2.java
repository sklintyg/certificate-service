        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_BESKRIVNING_V2_ID, (short) 250)))
        .shouldValidate(
            ElementDataPredicateFactory.valueBoolean(
                QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_V2_ID))
        .mapping(new ElementMapping(QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_V2_ID, null))
