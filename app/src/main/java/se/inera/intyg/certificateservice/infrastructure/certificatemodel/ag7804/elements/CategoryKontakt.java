...
public class CategoryKontakt {
  ...
  public static final ElementId CATEGORY_ID = new ElementId("KAT_12");

  private CategoryKontakt() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification categoryKontakt(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Kontakt").build())
        .rules(
            List.of(
