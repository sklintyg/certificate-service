...
public class CategoryGrundForBedomning {
  ...
  public static ElementSpecification categoryGrundForBedomning(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(GRUND_FOR_BEDOMNING_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Grund för bedömning").build())
