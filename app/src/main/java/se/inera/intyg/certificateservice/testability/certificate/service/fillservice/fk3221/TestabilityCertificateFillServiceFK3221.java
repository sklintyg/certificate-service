 ...
 */
package se.inera.intyg.certificateservice.testability.certificate.service.fillservice.fk3221;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.CertificateModelFactoryFK3221.FK3221_V1_0;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionAktivitetsbegransningar.QUESTION_AKTIVITETSBEGRANSNINGAR_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionAnnanGrundForMedicinsktUnderlag.QUESTION_ANNAN_GRUND_FOR_MEDICINSKT_UNDERLAG_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionAnnanKroppsligFunktionMotivering.FUNKTIONSNEDSATTNING_MOTIVERING_ANNAN_KROPPSILIG_FUNKTION_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOSIS_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOS_1;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOS_2;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOS_3;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOS_4;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnos.DIAGNOS_5;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionDiagnosHistorik.DIAGNOSIS_MOTIVATION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionFunktionsnedsattning.FUNKTIONSNEDSATTNING_ANNAN_KROPPSILIG_FUNKTION_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionFunktionsnedsattning.FUNKTIONSNEDSATTNING_INTELLEKTUELL_FUNKTION_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionFunktionsnedsattning.FUNKTIONSNEDSATTNING_KOORDINATION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionFunktionsnedsattning.FUNKTIONSNEDSATTNING_PSYKISK_FUNKTION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionFunktionsnedsattning.FUNKTIONSNEDSATTNING_SINNESFUNKTION_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionGrundForMedicinsktUnderlag.UTLATANDE_BASERAT_PA_ANNAT_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionGrundForMedicinsktUnderlag.UTLATANDE_BASERAT_PA_DIGITALT_VARDMOTE_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionGrundForMedicinsktUnderlag.UTLATANDE_BASERAT_PA_FYSISKT_MOTE_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionGrundForMedicinsktUnderlag.UTLATANDE_BASERAT_PA_JOURNALUPPGIFTER_FIELD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionIntellektuellFunktionMotivering.FUNKTIONSNEDSATTNING_MOTIVERING_INTELLEKTUELL_FUNKTION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionKommunikationSocialInteraktionMotivering.FUNKTIONSNEDSATTNING_MOTIVERING_KOMMUNIKATION_SOCIAL_INTERAKTION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionKoordinationMotivering.FUNKTIONSNEDSATTNING_MOTIVERING_KOORDINATION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionOvrigt.QUESTION_OVRIGT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionPsykiskFunktionMotivering.FUNKTIONSNEDSATTNING_MOTIVERING_PSYKISK_FUNKTION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionRelationTillPatienten.QUESTION_RELATION_TILL_PATIENTEN_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionUtredningEllerUnderlag.MEDICAL_INVESTIGATION_FIELD_ID_1;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionUtredningEllerUnderlag.MEDICAL_INVESTIGATION_FIELD_ID_2;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionUtredningEllerUnderlag.MEDICAL_INVESTIGATION_FIELD_ID_3;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionUtredningEllerUnderlag.QUESTION_ANDRA_MEDICINSKA_UTREDNINGAR_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3221.elements.QuestionVardenhetOchTidplan.QUESTION_VARDENHET_OCH_TIDPLAN_ID;
...
@Component
public class TestabilityCertificateFillServiceFK3221 implements TestabilityCertificateFillService {
  ...
  private static List<ElementData> fillWithValues(
    ...
    final var specBaseratPa = spec(QUESTION_GRUND_FOR_MEDICINSKT_UNDERLAG_ID, certificateModel);
    final var specBaseratPaAnhorig = spec(QUESTION_RELATION_TILL_PATIENTEN_ID, certificateModel);
    final var specBaseratPaAnnat =
        spec(QUESTION_ANNAN_GRUND_FOR_MEDICINSKT_UNDERLAG_ID, certificateModel);
    final var specAnnanUtredning = spec(QUESTION_BASERAT_PA_ANNAT_UNDERLAG_ID, certificateModel);
    ...
    final var specDiagnoshistorik = spec(DIAGNOSIS_MOTIVATION_ID, certificateModel);
    final var specFunktionsnedsattning = spec(FUNKTIONSNEDSATTNING_ID, certificateModel);
    ...
    final var specAnsvarigVardenhet = spec(QUESTION_VARDENHET_OCH_TIDPLAN_ID, certificateModel);
    final var specPrognos = spec(QUESTION_PROGNOS_ID, certificateModel);
    final var specOvrigt = spec(QUESTION_OVRIGT_ID, certificateModel);
  ...
  private static void baseratPaAnhorig(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
  ...
  private static void annanUtredning(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
  ...
  private static void medicinskaUtredningar(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL
        && emptyValue(spec)
            instanceof ElementValueMedicalInvestigationList medicalInvestigationList) {
      final var investigations =
          List.of(
              investigation(
  ...
  private static void funktionsnedsattning(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (emptyValue(spec) instanceof ElementValueCodeList elementValueCodeList) {
      ...
      final var codeList =
          elementValueCodeList.withList(fillType == MAXIMAL ? codes : codes.subList(0, 1));
  ...
  private static void psykosocial(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL && emptyValue(spec) instanceof ElementValueText elementValueText) {
  ...
  private static void uppmarksamhet(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL && emptyValue(spec) instanceof ElementValueText elementValueText) {
  ...
  private static void koordination(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL && emptyValue(spec) instanceof ElementValueText elementValueText) {
  ...
  private static void annanKroppslig(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL && emptyValue(spec) instanceof ElementValueText elementValueText) {
  ...
  private static void ansvarigVardenhet(
      ElementSpecification spec, List<ElementData> list, TestabilityFillTypeDTO fillType) {
    if (fillType == MAXIMAL && emptyValue(spec) instanceof ElementValueText elementValueText) {
