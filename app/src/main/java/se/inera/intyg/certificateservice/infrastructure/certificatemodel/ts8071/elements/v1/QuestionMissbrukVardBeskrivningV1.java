...
public class QuestionMissbrukVardBeskrivningV1 {
  ...
  public static final ElementId QUESTION_MISSBRUK_VARD_BESKRIVNING_V1_ID = new ElementId("18.7");
  public static final FieldId QUESTION_MISSBRUK_VARD_BESKRIVNING_V1_FIELD_ID = new FieldId("18.7");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.limit(
                    QUESTION_MISSBRUK_VARD_BESKRIVNING_V1_ID, (short) 250)))
        .shouldValidate(ElementDataPredicateFactory.valueBoolean(QUESTION_MISSBRUK_VARD_V1_ID))
