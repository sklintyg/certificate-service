...
public class QuestionPsykiskTidpunktV1 {
  ...
  public static final ElementId QUESTION_PSYKISK_TIDPUNKT_V1_ID = new ElementId("19.3");
  public static final FieldId QUESTION_PSYKISK_TIDPUNKT_FIELD_V1_ID = new FieldId("19.3");
        ...
        .rules(
            List.of(
                ...
                CertificateElementRuleFactory.mandatory(
                    QUESTION_PSYKISK_TIDPUNKT_V1_ID, QUESTION_PSYKISK_TIDPUNKT_FIELD_V1_ID),
                CertificateElementRuleFactory.limit(QUESTION_PSYKISK_TIDPUNKT_V1_ID, (short) 50)))
        .shouldValidate(ElementDataPredicateFactory.valueBoolean(QUESTION_PSYKISK_V1_ID))
        .mapping(new ElementMapping(QUESTION_PSYKISK_V1_ID, null))
