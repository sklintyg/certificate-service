...
public class CategorySynfunktion {
  ...
  public static ElementSpecification categorySynfunktion(ElementSpecification... children) {
    return ElementSpecification.builder()
        .id(INTYGET_SYNFUNKTION_CATEGORY_ID)
        .configuration(ElementConfigurationCategory.builder().name("Synfunktioner").build())
