...
public class PrefillRadioMultipleCodeConverter implements PrefillStandardConverter {
  ...
  public PrefillAnswer prefillAnswer(ElementSpecification specification, Forifyllnad prefill) {
    if (!(specification.configuration()
        instanceof ElementConfigurationRadioMultipleCode configurationRadioMultipleCode)) {
  ...
  private static FieldId getId(
      ElementConfigurationRadioMultipleCode configurationRadioMultipleCode, Code code) {
    return configurationRadioMultipleCode.list().stream()
