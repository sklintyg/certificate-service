...
public class XmlGeneratorHosPersonal {
  ...
  public static HosPersonal hosPersonal(Certificate certificate) {
    final var hosPersonal = hosPersonalWithoutEnhet(certificate.certificateMetaData().issuer());
  ...
  public static Enhet enhet(
    ...
    enhet.setVardgivare(vardgivare(certificateMetaData.careProvider()));
