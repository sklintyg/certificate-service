...
class XmlGeneratorDateTest {
  ...
  @InjectMocks private XmlGeneratorDate xmlGeneratorDate;
  ...
  void shouldMapDate() {
    final var data =
        ElementData.builder()
            ...
            .value(ElementValueDate.builder().date(DATE).dateId(new FieldId(ANSWER_ID)).build())
            .build();
  ...
  void shouldMapEmptyIfNoValue() {
    final var data =
        ElementData.builder()
            .value(ElementValueDate.builder().dateId(new FieldId(ANSWER_ID)).build())
            .id(new ElementId(QUESTION_ID))
            .build();
