...
class ElementValidationVisualAcuitiesTest {
  ...
  class ValidateElementData {
    ...
    void setUp() {
      elementValidationVisualAcuities =
          new ElementValidationVisualAcuities(true, 0.0, 2.0, null, null);
    }
    ...
    void shallThrowIfElementDataIsNull() {
      final var illegalArgumentException =
          assertThrows(
              ...
              () ->
                  elementValidationVisualAcuities.validate(
                      null, CATEGORY_ID, Collections.emptyList()));
    ...
    void shallThrowIfElementDataValueIsNull() {
      ...
      final var illegalArgumentException =
          assertThrows(
              ...
              () ->
                  elementValidationVisualAcuities.validate(
                      elementData, CATEGORY_ID, Collections.emptyList()));
    ...
    void shallThrowIfElementDataValueIsWrongType() {
      ...
      final var elementData = ElementData.builder().value(elementValueText).build();
      ...
      assertEquals(
          "Element data value %s is of wrong type".formatted(elementValueText.getClass()),
  ...
  class MandatoryTests {
    ...
    void setUp() {
      elementValidationVisualAcuities =
          new ElementValidationVisualAcuities(true, null, null, null, null);
    }
  ...
  class NotMandatoryTests {
    ...
    void setUp() {
      elementValidationVisualAcuities =
          new ElementValidationVisualAcuities(false, null, null, null, null);
    }
  ...
  class MaxValueTest {
    ...
    void setUp() {
      elementValidationVisualAcuities =
          new ElementValidationVisualAcuities(false, 0.0, 2.0, null, null);
    }
    ...
    void shallReturnValidationErrorIfRightEyeWithoutCorrectionValueExceedsMaxLimit() {
      final var validationError =
          ValidationError.builder()
              ...
              .fieldId(new FieldId(RIGHT_EYE_WITHOUT_CORRECTION_ID))
              .categoryId(CATEGORY_ID.orElse(null))
              .message(new ErrorMessage("Ange synskärpa i intervallet 0,0 - 2,0."))
              .build();
  ...
  class MinAllowedSightTests {
    ...
    void setUp() {
      elementValidationVisualAcuities =
          new ElementValidationVisualAcuities(false, 0.0, 2.0, 0.1, 0.8);
    }
      ...
      final var elementData =
          ElementData.builder()
              ...
              .value(
                  ElementValueVisualAcuities.builder()
                      .binocular(
                          getDefaultVisualActuityWithId(
                              BINOCULAR_WITHOUT_CORRECTION_ID, BINOCULAR_WITH_CORRECTION_ID))
                      .leftEye(
                          VisualAcuity.builder()
                              .withoutCorrection(
                                  Correction.builder()
  ...
  private static VisualAcuity getDefaultVisualActuity() {
    return VisualAcuity.builder()
        .withoutCorrection(Correction.builder().id(new FieldId("ID1")).value(1.0).build())
        .withCorrection(Correction.builder().id(new FieldId("ID2")).value(2.0).build())
        .build();
  }

  private static VisualAcuity getDefaultVisualActuityWithId(String withoutId, String withId) {
    return VisualAcuity.builder()
        .withoutCorrection(Correction.builder().id(new FieldId(withoutId)).value(1.0).build())
        .withCorrection(Correction.builder().id(new FieldId(withId)).build())
        .build();
  }
}
