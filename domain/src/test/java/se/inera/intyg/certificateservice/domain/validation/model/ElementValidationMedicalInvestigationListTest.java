...
class ElementValidationMedicalInvestigationListTest {
  ...
  private static final MedicalInvestigation EMPTY_MEDICAL_INV =
      MedicalInvestigation.builder()
          ...
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("EMPTY_CODE_ID")).build())
          .informationSource(
              ElementValueText.builder().textId(new FieldId("EMPTY_TEXT_ID")).build())
          .build();

  private static final MedicalInvestigation EMPTY_MEDICAL_INV_2 =
      MedicalInvestigation.builder()
          .id(new FieldId("EMPTY_MI_2"))
          .date(ElementValueDate.builder().dateId(new FieldId("EMPTY_DATE_ID_2")).build())
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("EMPTY_CODE_ID_2")).build())
          .informationSource(
              ElementValueText.builder().textId(new FieldId("EMPTY_TEXT_ID_2")).build())
          .build();

  public static final LocalDate MAX_DATE = LocalDate.now();
  public static final LocalDate DATE = LocalDate.now().plusDays(5);
  private static final MedicalInvestigation COMPLETE_MEDICAL_INV =
      MedicalInvestigation.builder()
          .id(new FieldId("COMPLETE_MI_1"))
          .date(ElementValueDate.builder().dateId(new FieldId("DATE_1")).date(DATE).build())
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("CODE_1")).code("CODE").build())
          .informationSource(
              ElementValueText.builder().textId(new FieldId("TEXT_1")).text("TEXT").build())
          .build();

  private static final MedicalInvestigation COMPLETE_MEDICAL_INV_2 =
      MedicalInvestigation.builder()
          .id(new FieldId("COMPLETE_MI_2"))
          .date(ElementValueDate.builder().dateId(new FieldId("DATE_11")).date(DATE).build())
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("CODE_11")).code("CODE").build())
          .informationSource(
              ElementValueText.builder().textId(new FieldId("TEXT_11")).text("TEXT").build())
          .build();

  private static final MedicalInvestigation INCOMPLETE_MEDICAL_INV_DATE =
      MedicalInvestigation.builder()
          .id(new FieldId("INCOMPLETE_MI_1"))
          .date(ElementValueDate.builder().dateId(new FieldId("DATE_1")).build())
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("CODE_1")).code("CODE").build())
          .informationSource(
              ElementValueText.builder().textId(new FieldId("TEXT_1")).text("TEXT").build())
  ...
  private static final MedicalInvestigation INCOMPLETE_MEDICAL_INV_TEXT =
      MedicalInvestigation.builder()
          .id(new FieldId("INCOMPLETE_MI_2"))
          .date(ElementValueDate.builder().dateId(new FieldId("DATE_2")).date(DATE).build())
          .investigationType(
              ElementValueCode.builder().codeId(new FieldId("CODE_2")).code("CODE").build())
          .informationSource(ElementValueText.builder().textId(new FieldId("TEXT_2")).build())
          .build();

  private static final MedicalInvestigation INCOMPLETE_MEDICAL_INV_CODE =
      MedicalInvestigation.builder()
          .id(new FieldId("INCOMPLETE_MI_3"))
          .date(ElementValueDate.builder().dateId(new FieldId("DATE_3")).date(DATE).build())
          .investigationType(ElementValueCode.builder().codeId(new FieldId("CODE_3")).build())
          .informationSource(
  ...
  class DateAfterMaxErrors {
    ...
    void shallReturnErrorMessageIfDateIsAfterMax() {
      validation =
          ElementValidationMedicalInvestigationList.builder().max(Period.ofDays(0)).build();
      ...
      final var elementData =
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      .id(FIELD_ID)
                      .list(List.of(COMPLETE_MEDICAL_INV, COMPLETE_MEDICAL_INV_2))
                      .build())
              .build();
  ...
  class DateBeforeMinErrors {
    ...
    void shallReturnErrorMessageIfDateIsBeforeMin() {
      validation =
          ElementValidationMedicalInvestigationList.builder().min(Period.ofDays(10)).build();
      final var expectedValidationError =
          getExpectedValidationErrorAsList(
  ...
  class MandatoryErrors {
    ...
    void shouldReturnMissingFieldsAndMandatoryValidationIfMandatoryAndFirstRowIncomplete() {
      validation = ElementValidationMedicalInvestigationList.builder().mandatory(true).build();
      final var categoryId = Optional.of(CATEGORY_ID);
      ...
      final var expectedValidationErrors =
          List.of(
              ...
              getExpectedValidationError(
                  "Ange ett svar.", INCOMPLETE_MEDICAL_INV_TEXT.informationSource().textId()));
      ...
      final var elementData =
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      .id(FIELD_ID)
                      .list(List.of(INCOMPLETE_MEDICAL_INV_TEXT))
                      .build())
              .build();
    ...
    void shouldReturnMissingFieldsAndMandatoryValidationIfMandatoryAndFirstRowEmpty() {
      ...
      final var elementData =
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      .id(FIELD_ID)
                      .list(List.of(EMPTY_MEDICAL_INV))
                      .build())
              .build();
      ...
      final var expectedValidationErrors =
          List.of(
              ...
              getExpectedValidationError(
                  "Välj ett alternativ.", EMPTY_MEDICAL_INV.investigationType().codeId()),
              getExpectedValidationError(
                  "Ange ett svar.", EMPTY_MEDICAL_INV.informationSource().textId()));
      final var validationErrors =
          validation.validate(elementData, categoryId, Collections.emptyList());
      ...
      final var elementData =
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      .id(FIELD_ID)
                      .list(List.of(EMPTY_MEDICAL_INV, INCOMPLETE_MEDICAL_INV_DATE))
                      .build())
              .build();

      final var expectedValidationErrors =
          List.of(
              getExpectedValidationError("Fyll i fälten uppifrån och ned.", FIELD_ID),
              getExpectedValidationError("Ange ett datum.", EMPTY_MEDICAL_INV.date().dateId()),
              getExpectedValidationError(
                  "Välj ett alternativ.", EMPTY_MEDICAL_INV.investigationType().codeId()),
              getExpectedValidationError(
                  "Ange ett svar.", EMPTY_MEDICAL_INV.informationSource().textId()),
              getExpectedValidationError(
                  "Ange ett datum.", INCOMPLETE_MEDICAL_INV_DATE.date().dateId()));
          ...
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      .id(FIELD_ID)
                      .list(
                          List.of(COMPLETE_MEDICAL_INV, EMPTY_MEDICAL_INV, COMPLETE_MEDICAL_INV_2))
                      .build())
              .build();
    ...
    void shouldReturnWrongOrderAndMissingFieldsIfThirdIsIncomplete() {
          ...
          ElementData.builder()
              ...
              .value(
                  ElementValueMedicalInvestigationList.builder()
                      ...
                      .list(
                          List.of(
                              EMPTY_MEDICAL_INV, EMPTY_MEDICAL_INV_2, INCOMPLETE_MEDICAL_INV_CODE))
                      .build())
              .build();
      ...
      final var expectedValidationErrors =
          List.of(
              ...
              getExpectedValidationError(
                  "Välj ett alternativ.", EMPTY_MEDICAL_INV_2.investigationType().codeId()),
              getExpectedValidationError(
                  "Ange ett svar.", EMPTY_MEDICAL_INV_2.informationSource().textId()),
              getExpectedValidationError(
                  "Välj ett alternativ.",
                  INCOMPLETE_MEDICAL_INV_CODE.investigationType().codeId()));
  ...
  class TextLimitError {
    ...
    void shouldReturnErrorIfTextIsOverLimit() {
      ...
      assertEquals(
          getExpectedValidationErrorAsList(
              "Ange en text som inte är längre än 1.",
              COMPLETE_MEDICAL_INV.informationSource().textId()),
          validationErrors);
    }
  ...
  private static List<ValidationError> getExpectedValidationErrorAsList(
      String message, FieldId fieldId) {
    return List.of(getExpectedValidationError(message, fieldId));
  }
}
