...
import static se.inera.intyg.certificateservice.domain.action.certificate.model.CertificateActionType.COMPLEMENT;
...
class ComplementCertificateDomainServiceTest {

  @Mock private CertificateRepository certificateRepository;
  @Mock private CertificateEventDomainService certificateEventDomainService;
  @InjectMocks private ComplementCertificateDomainService complementCertificateDomainService;
  ...
  void shallThrowExceptionIfUserHasNoAccessToComplement() {
    ...
    assertThrows(
        ...
        () ->
            complementCertificateDomainService.complement(
  ...
  void shallComplementCertificate() {
    ...
    verify(certificate).complement(ACTION_EVALUATION);
  }
  ...
  void shallPublishComplementCertificateEvent() {
    ...
    assertAll(
        () ->
            assertEquals(CertificateEventType.COMPLEMENT, certificateEventCaptor.getValue().type()),
  ...
  void shallIncludeReasonNotAllowedToException() {
    ...
    doReturn(expectedReason)
        .when(certificate)
        .reasonNotAllowed(COMPLEMENT, Optional.of(ACTION_EVALUATION));
