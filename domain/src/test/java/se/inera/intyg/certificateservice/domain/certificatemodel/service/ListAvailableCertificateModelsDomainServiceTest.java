...
class ListAvailableCertificateModelsDomainServiceTest {
  ...
  private static final CertificateModelId CERTIFICATE_MODEL_ID_1 =
      CertificateModelId.builder().type(CERTIFICATE_TYPE_1).build();
  private static final CertificateModelId CERTIFICATE_MODEL_ID_2 =
      CertificateModelId.builder().type(CERTIFICATE_TYPE_2).build();
  @Mock CertificateModel certificateModelOne;
  @Mock CertificateModel certificateModelTwo;
  ...
  void shallFilterOnCertificateActionTypeAccessForRole() {
    final var certificateModels = List.of(certificateModelOne, certificateModelTwo);
    ...
    doReturn(true)
        .when(certificateModelOne)
        .allowTo(LIST_CERTIFICATE_TYPE, Optional.of(actionEvaluation));
    doReturn(false)
        .when(certificateModelTwo)
        .allowTo(LIST_CERTIFICATE_TYPE, Optional.of(actionEvaluation));

    final var actualCertificateModels =
        listAvailableCertificateModelsDomainService.get(actionEvaluation);
                ...
                .configuration(
                    List.of(
                        CertificateAccessUnitConfiguration.builder()
                            ...
                            .type("block")
                            .issuedOnUnit(List.of(ALFA_ALLERGIMOTTAGNINGEN.hsaId().id()))
                            .build()))
                .build());
  ...
  void shallReturnOnlyLatestVersionWhenMultipleMajorVersionsExist() {
    ...
    doReturn(List.of(certificateModelOne, certificateModelTwo))
    ...
    final var actualCertificateModels =
        listAvailableCertificateModelsDomainService.getLatestVersions(actionEvaluation);
