...
class GetCertificatesWithQAInternalDomainServiceTest {
  ...
  @Mock XmlGeneratorCertificatesForCareWithQA xmlGeneratorCertificatesForCareWithQA;
  ...
  void shallReturnXml() {
    ...
    final List<Certificate> certificates =
        List.of(MedicalCertificate.builder().build(), MedicalCertificate.builder().build());
