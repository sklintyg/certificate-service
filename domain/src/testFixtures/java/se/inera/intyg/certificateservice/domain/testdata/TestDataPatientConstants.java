...
public class TestDataPatientConstants {
  ...
  public static final String ATHENA_REACT_ANDERSSON_FULL_NAME =
      "%s %s %s"
          .formatted(
  ...
  public static final ProtectedPerson ATHENA_REACT_ANDERSSON_PROTECTED_PERSON =
      PROTECTED_PERSON_FALSE;
  ...
  public static final String ALVE_REACT_ALFREDSSON_FULL_NAME =
      "%s %s %s"
          .formatted(
  ...
  public static final ProtectedPerson ALVE_REACT_ALFREDSSON_PROTECTED_PERSON =
      PROTECTED_PERSON_FALSE;
  ...
  public static final String ATLAS_REACT_ABRAHAMSSON_FULL_NAME =
      "%s %s %s"
          .formatted(
  ...
  public static final ProtectedPerson ATLAS_REACT_ABRAHAMSSON_PROTECTED_PERSON =
      PROTECTED_PERSON_FALSE;
  ...
  public static final String ANONYMA_REACT_ATTILA_FULL_NAME =
      "%s %s %s"
          .formatted(
