...
public class TestDataCertificateModelConstants {
  ...
  public static final CertificateModelId FK7210_ID =
      CertificateModelId.builder().type(FK7210_TYPE).version(FK7210_VERSION).build();
  public static final CertificateModelId FK7804_ID =
      CertificateModelId.builder().type(FK7804_TYPE).version(FK7804_VERSION).build();
  public static final Code FK7210_CODE_TYPE =
      new Code("IGRAV", "b64ea353-e8f6-4832-b563-fc7d46f29548", "Intyg om graviditet");
  public static final Code FK3226_CODE_TYPE =
      new Code("LUNSP", "b64ea353-e8f6-4832-b563-fc7d46f29548", "Intyg om graviditet");
  public static final Code FK7472_CODE_TYPE =
      new Code(
          "ITFP", "b64ea353-e8f6-4832-b563-fc7d46f29548", "Intyg om tillfällig föräldrapenning");
  public static final Code FK7809_CODE_TYPE =
      new Code(
          "LUMEK",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarutlåtande för merkostnadsersättning");
  public static final Code FK7427_CODE_TYPE =
      new Code(
          "LU_TFP_B12_16",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarutlåtande tillfällig föräldrapenning barn 12–16 år");
  public static final Code FK7426_CODE_TYPE =
      new Code(
          "LU_TFP_ASB18",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarutlåtande tillfällig föräldrapenning för ett allvarligt sjukt barn som inte har fyllt 18");
  public static final Code FK3221_CODE_TYPE =
      new Code(
          "LU_OMV_MEK",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarutlåtande för omvårdnadsbidrag eller merkostnadsersättning");
  public static final Code FK7810_CODE_TYPE =
      new Code(
          "LUAS", "b64ea353-e8f6-4832-b563-fc7d46f29548", "Läkarutlåtande för assistansersättning");
  public static final Code FK7804_CODE_TYPE =
      new Code("LISJP", "b64ea353-e8f6-4832-b563-fc7d46f29548", "Läkarintyg för sjukpenning");
  public static final Code AG7804_CODE_TYPE =
      new Code(
          "AG7804",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarintyg om arbetsförmåga – arbetsgivaren");
  public static final Code AG114_CODE_TYPE =
      new Code(
          "AG114",
          "b64ea353-e8f6-4832-b563-fc7d46f29548",
          "Läkarintyg om arbetsförmåga – sjuklöneperioden");

  public static final SchematronPath FK7210_SCHEMATRON_PATH =
      new SchematronPath("fk7210/schematron/igrav.v1.sch");
  public static final SchematronPath FK3226_SCHEMATRON_PATH =
      new SchematronPath("fk3226/schematron/lunsp.v1.sch");
  public static final SchematronPath FK7472_SCHEMATRON_PATH =
      new SchematronPath("fk7472/schematron/itfp.v1.sch");
  public static final SchematronPath FK7809_SCHEMATRON_PATH =
      new SchematronPath("fk7809/schematron/lumek.v1.sch");
  public static final SchematronPath FK7426_SCHEMATRON_PATH =
      new SchematronPath("fk7426/schematron/lu_tfp_b12_16.v1.sch");
  public static final SchematronPath FK3221_SCHEMATRON_PATH =
      new SchematronPath("fk3221/schematron/lu_omv_mek.v1.sch");
  public static final SchematronPath FK7810_SCHEMATRON_PATH =
      new SchematronPath("fk7810/schematron/luas.v1.sch");
  public static final SchematronPath FK7804_SCHEMATRON_PATH =
  ...
  public static final String FK7427_NAME =
      "Läkarutlåtande tillfällig föräldrapenning barn 12–16 år";
  public static final String FK7426_NAME =
      "Läkarutlåtande tillfällig föräldrapenning för ett allvarligt sjukt barn som inte har fyllt 18";
  public static final String FK3221_NAME =
      "Läkarutlåtande för omvårdnadsbidrag eller merkostnadsersättning";
  ...
  public static final Recipient FK_RECIPIENT =
      new Recipient(new RecipientId("FKASSA"), "Försäkringskassan", "Logisk adress");
  public static Recipient SKR_RECIPIENT =
      new Recipient(new RecipientId("SKR"), "Sveriges Kommuner och Regioner", null);
}
