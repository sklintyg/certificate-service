...
public class GetSickLeaveCertificateDomainService {
  ...
  public Optional<SickLeaveCertificate> get(CertificateId certificateId, boolean ignoreModelRules) {
    ...
    final var sickLeave =
        certificate.certificateModel().sickLeaveProvider().build(certificate, ignoreModelRules);
