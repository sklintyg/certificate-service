...
public class ElementConfigurationMedicalInvestigationList implements ElementConfiguration {
                ...
                .map(
                    config ->
                        MedicalInvestigation.builder()
                            .id(config.id())
                            .date(ElementValueDate.builder().dateId(config.dateId()).build())
                            .investigationType(
            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        "Cannot find matching medical investigation with codeId '%s'"
                            .formatted(code.codeId())));
  ...
  private Optional<Code> findLegacyCodeMapping(
      MedicalInvestigationConfig config, String codeValue) {
