...
public class CertificateActionSendAfterComplement implements CertificateAction {
  ...
  public boolean evaluate(
      Optional<Certificate> optionalCertificate, Optional<ActionEvaluation> actionEvaluation) {
    return actionRules.stream()
