...
public class SaveAnswerDomainService {
  ...
  public Message save(
      ...
      Content content) {
    if (!certificate.allowTo(CertificateActionType.SAVE_ANSWER, Optional.of(actionEvaluation))) {
      throw new CertificateActionForbidden(
          "Not allowed to save answer on certificate for %s".formatted(certificate.id().id()),
