...
public class DeleteMessageDomainService {
  ...
  public void delete(MessageId messageId, ActionEvaluation actionEvaluation) {
    ...
    if (!certificate.allowTo(CertificateActionType.DELETE_MESSAGE, Optional.of(actionEvaluation))) {
      throw new CertificateActionForbidden(
          "Not allowed to delete messages on certificate for %s".formatted(certificate.id().id()),
