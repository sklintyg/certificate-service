...
public class CertificateActionReadyForSign implements CertificateAction {

  private static final String NAME = "Markera klart för signering";
  private static final String DESCRIPTION = "Utkastet markeras som klar för signering.";
