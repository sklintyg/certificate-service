...
public class ElementConfigurationDiagnosis implements ElementConfiguration {
  ...
  FieldId id;
  @Builder.Default List<ElementDiagnosisTerminology> terminology = Collections.emptyList();
  @Builder.Default List<ElementDiagnosisListItem> list = Collections.emptyList();

  @Override
  public ElementValue emptyValue() {
    return ElementValueDiagnosisList.builder().diagnoses(Collections.emptyList()).build();
  }
