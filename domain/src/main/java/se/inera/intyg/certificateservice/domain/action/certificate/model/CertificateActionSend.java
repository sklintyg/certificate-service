...
public class CertificateActionSend implements CertificateAction {
  ...
  private static final String DESCRIPTION_FK =
      "Öppnar ett fönster där du kan välja att skicka intyget till Försäkringskassan.";
  private static final String BODY_FK =
  ...
  private static final String UNABLE_TO_RETRIEVE_RECIPIENT_FOR_CERTIFICATE =
      "Unable to retrieve recipient for certificate";
  ...
  public String getName(Optional<Certificate> certificate) {
    return getRecipient(certificate)
        ...
        .orElseThrow(() -> new IllegalStateException(UNABLE_TO_RETRIEVE_RECIPIENT_FOR_CERTIFICATE));
  }
                    ...
                    .orElseThrow(
                        () ->
                            new IllegalStateException(
                                UNABLE_TO_RETRIEVE_RECIPIENT_FOR_CERTIFICATE)));
  }
  ...
  private static Optional<Recipient> getRecipient(Optional<Certificate> certificate) {
    return certificate.map(Certificate::certificateModel).map(CertificateModel::recipient);
  }
}
