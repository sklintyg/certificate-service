...
public class SaveMessageDomainService {
  ...
  public Message save(
    ...
    if (!certificate.allowTo(CertificateActionType.SAVE_MESSAGE, Optional.of(actionEvaluation))) {
      throw new CertificateActionForbidden(
          "Not allowed to save messages on certificate for %s".formatted(certificate.id().id()),
