...
import se.inera.intyg.certificateservice.integrationtest.common.tests.CreateDraftFromCertificateIT;
...
public class AG7804ActiveIT extends ActiveCertificatesIT {
  ...
  class CreateDraftFromCertificate extends CreateDraftFromCertificateIT {
