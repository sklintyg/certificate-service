...
class TS8071V1LimitedFunctionalityIT extends ActiveCertificatesIT {
  ...
  @Test
  @DisplayName(
      "Should be able to update the V1 certificate with limited functionality before expiration.")
  ...
  @Test
  @DisplayName(
      "shall have update action for V1 certificate when limited functionality before expiration")
