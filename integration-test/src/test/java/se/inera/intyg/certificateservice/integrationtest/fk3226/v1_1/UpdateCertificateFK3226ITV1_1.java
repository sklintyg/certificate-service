...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionForutsattningarForAttLamnaSkriftligtSamtycke.FORUTSATTNINGAR_FOR_ATT_LAMNA_SKRIFTLIGT_SAMTYCKE_FIELD_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionPatientensBehandlingOchVardsituation.QUESTION_PATIENTENS_BEHANDLING_OCH_VARDSITUATION_FIELD_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.fk3226.v1.elements.QuestionUtlatandeBaseratPa.QUESTION_UTLATANDE_BASERAT_PA_FIELD_ID;
...
public abstract class UpdateCertificateFK3226ITV1_1 extends BaseIntegrationIT {

  @Test
  @DisplayName(
      "Om intyget får ett uppdaterat värde för grund för medicinskt underlag ska intyget uppdateras")
  ...
  void shallUpdateDataForDiagnosis() {
    ...
    Objects.requireNonNull(
        certificate
            .getData()
            .put(DIAGNOSIS_ID.id(), updateValue(certificate, DIAGNOSIS_ID.id(), expectedData)));
