...
public abstract class UpdateCertificateFK7809IT extends BaseIntegrationIT {
  ...
  void shallUpdateDataForMedicalExamination() {
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateValue(
                    certificate, QUESTION_GRUND_FOR_MEDICINSKT_UNDERLAG_ID.id(), expectedData)));
    ...
    assertEquals(
        expectedData, getValueDateList(response, QUESTION_GRUND_FOR_MEDICINSKT_UNDERLAG_ID.id()));
  }
  ...
  void shallUpdateDataForOtherTreatments() {
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateValue(
                    certificate, QUESTION_BASERAT_PA_ANNAT_UNDERLAG_ID.id(), expectedData)));
    ...
    assertEquals(
        expectedData, getValueBoolean(response, QUESTION_BASERAT_PA_ANNAT_UNDERLAG_ID.id()));
  }
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateTextValue(certificate, DIAGNOSIS_MOTIVATION_ID.id(), text)));
  ...
  @Test
  @DisplayName(
      "Om intyget får ett uppdaterat värde för typ av funktionsnedsättning ska intyget uppdateras")
  void shallUpdateDataForDisabilityCode() {
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateValue(certificate, FUNKTIONSNEDSATTNING_ID.id(), expectedData)));
    ...
    assertEquals(expectedData, getValueCodeList(response, FUNKTIONSNEDSATTNING_ID.id()));
  }

  @Test
  @DisplayName(
      "Om intyget får ett uppdaterat värde för aktivitetsbegränsningar ska intyget uppdateras")
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateTextValue(certificate, QUESTION_AKTIVITETSBEGRANSNINGAR_ID.id(), text)));
  ...
  @Test
  @DisplayName(
      "Om intyget får ett uppdaterat värde för medicinsk behandling ska intyget uppdateras")
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateTextValue(
                    certificate, QUESTION_PAGAENDE_ELLER_PLANERAD_BEHANDLING_ID.id(), text)));
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateTextValue(certificate, QUESTION_PROGNOS_ID.id(), text)));
    ...
    Objects.requireNonNull(
        certificate
            ...
            .put(
                ...
                updateTextValue(certificate, QUESTION_OVRIGT_ID.id(), text)));
