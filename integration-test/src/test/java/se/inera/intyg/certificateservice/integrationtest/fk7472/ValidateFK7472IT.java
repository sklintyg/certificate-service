...
public abstract class ValidateFK7472IT extends BaseIntegrationIT {
  ...
  @Test
  @DisplayName(
      "Om utkastet innehåller 'symtom' längre än 318 tecken ska ett valideringsmeddelande visas.")
  ...
  void shallReturnListOfErrorsIfTextOfSymtomIsMissing() {
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                validationErrors(response).get(0).getText().contains("Ange ett svar."),
                () ->
  ...
  void shallReturnListOfErrorsIfDateRangeListOfPeriodIsMissing() {
        ...
        certificate
            ...
            .put(
                ...
                updateDateRangeListValue(
                    certificate, QUESTION_PERIOD_ID.id(), Collections.emptyList())));
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                validationErrors(response).get(0).getText().contains("Välj minst ett alternativ."),
                () ->
  ...
  void shallReturnListOfErrorsIfDateRangeListOfPeriodIsNotComplete() {
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                validationErrors(response).get(0).getField().contains("HALVA.from"),
                () ->
