...
public abstract class GetCertificateGeneralPdfIT extends BaseIntegrationIT {
  ...
  @Test
  @DisplayName(
      "Om intyget är utfärdat på en annan mottagning ska felkod 403 (FORBIDDEN) returneras")
  ...
  @ParameterizedTest
  @DisplayName(
      "Om intyget är utfärdat på en patient som har skyddade personuppgifter ska felkod 403 (FORBIDDEN) returneras")
  ...
  @Test
  @DisplayName(
      "Läkare - Om intyget är utfärdat på en patient som har skyddade personuppgifter ska pdf returneras")
